...
module ModernTreasury
  module Internal
    ...
    module Util
      ...
      #   structure when using `ModernTreasury::Internal::Util.deep_merge`.
      #
      ...
      class << self
        ...
        sig do
          params(
            data: T.any(ModernTreasury::Internal::Util::AnyHash, T::Array[T.anything], T.anything),
      ...
      class << self
        # @api private
        sig do
          params(url: T.any(URI::Generic, String)).returns(ModernTreasury::Internal::Util::ParsedUriShape)
        end
        def parse_uri(url)
        end

        # @api private
        sig { params(parsed: ModernTreasury::Internal::Util::ParsedUriShape).returns(URI::Generic) }
      ...
      class << self
        ...
        sig { params(lines: T::Enumerable[String]).returns(ModernTreasury::Internal::Util::ServerSentEvent) }
