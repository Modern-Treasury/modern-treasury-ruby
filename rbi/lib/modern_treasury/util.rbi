...
module ModernTreasury
  ...
  module Util
    ...
    #   structure when using `ModernTreasury::Util.deep_merge`.
    #
    ...
    class << self
      ...
      sig do
        params(
          data: T.any(ModernTreasury::Util::AnyHash, T::Array[T.anything], T.anything),
    ...
    class << self
      # @api private
      sig { params(url: T.any(URI::Generic, String)).returns(ModernTreasury::Util::ParsedUriShape) }
      def parse_uri(url)
      end

      # @api private
      sig { params(parsed: ModernTreasury::Util::ParsedUriShape).returns(URI::Generic) }
      def unparse_uri(parsed)
      end

      # @api private
      sig do
        params(lhs: ModernTreasury::Util::ParsedUriShape, rhs: ModernTreasury::Util::ParsedUriShape)
          .returns(URI::Generic)
      end
    ...
    class << self
      ...
      sig { params(lines: T::Enumerable[String]).returns(ModernTreasury::Util::ServerSentEvent) }
