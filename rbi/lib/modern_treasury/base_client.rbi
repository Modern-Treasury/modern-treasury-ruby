...
module ModernTreasury
  class BaseClient
    ...
    sig do
      params(request: ModernTreasury::BaseClient::RequestInputShape, status: Integer, location_header: String)
        .returns(ModernTreasury::BaseClient::RequestInputShape)
    end
    ...
    sig do
      params(req: ModernTreasury::BaseClient::RequestComponentsShape, response: NilClass).returns(T.anything)
    end
