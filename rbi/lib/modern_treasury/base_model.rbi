...
module ModernTreasury
  ...
  module Converter
    ...
    # @api private
    sig { overridable.params(value: T.anything, state: ModernTreasury::Converter::State).returns(T.anything) }
    ...
    class << self
      ...
      sig do
        params(
          target: ModernTreasury::Converter::Input,
          value: T.anything,
          state: ModernTreasury::Converter::State
        )
          .returns(T.anything)
      end
      def self.coerce(
  ...
  class Unknown
    ...
    class << self
      # @api private
      sig(:final) do
        override.params(value: T.anything, state: ModernTreasury::Converter::State).returns(T.anything)
      end
      def coerce(value, state:)
      end
  ...
  class BooleanModel
    ...
    class << self
      ...
      sig(:final) do
        override
          .params(value: T.any(T::Boolean, T.anything), state: ModernTreasury::Converter::State)
  ...
  module Enum
    ...
    sig do
      override
        .params(value: T.any(String, Symbol, T.anything), state: ModernTreasury::Converter::State)
  ...
  module Union
    ...
    sig { returns(T::Array[[T.nilable(Symbol), T.proc.returns(ModernTreasury::Converter::Input)]]) }
    ...
    sig do
      params(
        key: T.any(Symbol, ModernTreasury::Util::AnyHash, T.proc.returns(T.anything), T.anything),
        spec: T.any(ModernTreasury::Util::AnyHash, T.proc.returns(T.anything), T.anything)
      )
        .void
    end
    ...
    # @api private
    sig { override.params(value: T.anything, state: ModernTreasury::Converter::State).returns(T.anything) }
    def coerce(value, state:)
    end
  ...
  class ArrayOf
    ...
    sig(:final) do
      override
        .params(value: T.any(T::Enumerable[T.anything], T.anything), state: ModernTreasury::Converter::State)
  ...
  class BaseModel
    ...
    class << self
      ...
      sig do
        override
          .params(
            value: T.any(ModernTreasury::BaseModel, T::Hash[T.anything, T.anything], T.anything),
            state: ModernTreasury::Converter::State
          )
    ...
    sig { overridable.returns(ModernTreasury::Util::AnyHash) }
    def to_h
    end
    ...
    sig { params(keys: T.nilable(T::Array[Symbol])).returns(ModernTreasury::Util::AnyHash) }
