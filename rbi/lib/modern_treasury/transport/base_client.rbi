...
module ModernTreasury
  module Transport
    ...
    class BaseClient
        ...
        T.type_alias do
          {
            ...
            page: T.nilable(T::Class[ModernTreasury::Type::BasePage[ModernTreasury::BaseModel]]),
            stream: T.nilable(T::Class[T.anything]),
            model: T.nilable(ModernTreasury::Type::Converter::Input),
      ...
      class << self
        # @api private
        sig { params(req: ModernTreasury::Transport::BaseClient::RequestComponentsShape).void }
        def validate!(req)
        end
        ...
        sig do
          params(
            request: ModernTreasury::Transport::BaseClient::RequestInputShape,
            status: Integer,
            response_headers: T.any(T::Hash[String, String], Net::HTTPHeader)
          )
            .returns(ModernTreasury::Transport::BaseClient::RequestInputShape)
        end
      ...
      # @api private
      sig { returns(ModernTreasury::Transport::PooledNetRequester) }
      ...
      sig do
        overridable
          .params(
            req: ModernTreasury::Transport::BaseClient::RequestComponentsShape,
            opts: ModernTreasury::Util::AnyHash
          )
          .returns(ModernTreasury::Transport::BaseClient::RequestInputShape)
      end
