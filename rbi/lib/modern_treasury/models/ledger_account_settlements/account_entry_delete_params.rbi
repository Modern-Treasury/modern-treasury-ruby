    ...
    module LedgerAccountSettlements
      class AccountEntryDeleteParams < ModernTreasury::BaseModel
        ...
        Shape = T.type_alias do
          T.all({ledger_entry_ids: T::Array[T.anything]}, ModernTreasury::RequestParameters::Shape)
        end
        ...
        sig do
          params(ledger_entry_ids: T::Array[T.anything], request_options: ModernTreasury::RequestOpts).void
        end
