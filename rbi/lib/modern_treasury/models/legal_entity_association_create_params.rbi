...
module ModernTreasury
  module Models
    class LegalEntityAssociationCreateParams < ModernTreasury::BaseModel
      ...
      sig do
        params(_: ModernTreasury::Models::LegalEntityAssociationCreateParams::ChildLegalEntity).returns(ModernTreasury::Models::LegalEntityAssociationCreateParams::ChildLegalEntity)
      end
      ...
      class ChildLegalEntity < ModernTreasury::BaseModel
        sig do
          returns(T.nilable(T::Array[ModernTreasury::Models::LegalEntityAssociationCreateParams::ChildLegalEntity::Address]))
        end
        def addresses
        end

        sig do
          params(_: T::Array[ModernTreasury::Models::LegalEntityAssociationCreateParams::ChildLegalEntity::Address]).returns(T::Array[ModernTreasury::Models::LegalEntityAssociationCreateParams::ChildLegalEntity::Address])
        end
        def addresses=(_)
        end
        ...
        sig do
          returns(T.nilable(T::Array[ModernTreasury::Models::LegalEntityAssociationCreateParams::ChildLegalEntity::Identification]))
        end
        def identifications
        end
        ...
        sig do
          returns(T.nilable(T::Array[ModernTreasury::Models::LegalEntityAssociationCreateParams::ChildLegalEntity::PhoneNumber]))
        end
        def phone_numbers
        end
