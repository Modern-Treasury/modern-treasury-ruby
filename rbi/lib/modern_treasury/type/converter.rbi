...
module ModernTreasury
  module Type
    # @api private
    module Converter
      Input = T.type_alias { T.any(ModernTreasury::Type::Converter, T::Class[T.anything]) }
      ...
      class << self
        ...
        sig do
          params(
            target: ModernTreasury::Type::Converter::Input,
            value: T.anything,
            state: ModernTreasury::Type::Converter::State
          )
            .returns(T.anything)
        ...
        # @api private
        sig { params(target: ModernTreasury::Type::Converter::Input, value: T.anything).returns(T.anything) }
