        ...
        sig do
          returns(
            ...
            T.all(
              ...
              {type_fn: T.proc.returns(ModernTreasury::Type::Converter::Input)}
            )
            ]
          )
        end
        ...
        sig do
          returns(
            T::Hash[Symbol,
                    T.all(
                      ModernTreasury::BaseModel::KnownFieldShape,
                      {type: ModernTreasury::Type::Converter::Input}
                    )]
          )
        end
        def fields
            ...
            type_info: T.any(
              {
                ...
                enum: T.nilable(T.proc.returns(ModernTreasury::Type::Converter::Input)),
                union: T.nilable(T.proc.returns(ModernTreasury::Type::Converter::Input)),
                api_name: Symbol,
                nil?: T::Boolean
              },
