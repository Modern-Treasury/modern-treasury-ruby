...
module ModernTreasury
  module Models
    class PaymentOrderAsyncCreate < ModernTreasury::Internal::Type::BaseModel
      ...
      sig do
        returns(ModernTreasury::PaymentOrderAsyncCreate::Direction::OrSymbol)
      end
      ...
      sig do
        returns(
          T.nilable(ModernTreasury::PaymentOrderAsyncCreate::Priority::OrSymbol)
        )
      end
      ...
      sig do
        returns(
          T.nilable(ModernTreasury::PaymentOrderAsyncCreate::ReceivingAccount)
        )
      end
        ...
        override.returns(
          {
            ...
            originating_party_name: T.nilable(String),
            priority:
              ModernTreasury::PaymentOrderAsyncCreate::Priority::OrSymbol,
            process_after: T.nilable(Time),
            purpose: T.nilable(String),
            receiving_account:
              ModernTreasury::PaymentOrderAsyncCreate::ReceivingAccount,
            receiving_account_id: String,
            reconciliation_status:
              ModernTreasury::PaymentOrderAsyncCreate::ReconciliationStatus::OrSymbol,
            remittance_information: T.nilable(String),
      ...
      module Direction
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(Symbol, ModernTreasury::PaymentOrderAsyncCreate::Direction)
          end
        ...
        CREDIT =
          T.let(
            :credit,
            ModernTreasury::PaymentOrderAsyncCreate::Direction::TaggedSymbol
          )
        DEBIT =
          T.let(
            :debit,
      ...
      module ChargeBearer
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(Symbol, ModernTreasury::PaymentOrderAsyncCreate::ChargeBearer)
          end
        OrSymbol = T.type_alias { T.any(Symbol, String) }
        ...
        SHARED =
          T.let(
            :shared,
            ModernTreasury::PaymentOrderAsyncCreate::ChargeBearer::TaggedSymbol
          )
        SENDER =
          T.let(
            :sender,
      ...
      module FallbackType
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(Symbol, ModernTreasury::PaymentOrderAsyncCreate::FallbackType)
          end
        OrSymbol = T.type_alias { T.any(Symbol, String) }
        ...
        ACH =
          T.let(
            :ach,
            ModernTreasury::PaymentOrderAsyncCreate::FallbackType::TaggedSymbol
          )
      ...
      module ForeignExchangeIndicator
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(
              Symbol,
              ModernTreasury::PaymentOrderAsyncCreate::ForeignExchangeIndicator
            )
          end
        OrSymbol = T.type_alias { T.any(Symbol, String) }
        ...
        FIXED_TO_VARIABLE =
          T.let(
            :fixed_to_variable,
            ModernTreasury::PaymentOrderAsyncCreate::ForeignExchangeIndicator::TaggedSymbol
          )
        VARIABLE_TO_FIXED =
          T.let(
            :variable_to_fixed,
      ...
      module Priority
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(Symbol, ModernTreasury::PaymentOrderAsyncCreate::Priority)
          end
        OrSymbol = T.type_alias { T.any(Symbol, String) }
        ...
        HIGH =
          T.let(
            :high,
            ModernTreasury::PaymentOrderAsyncCreate::Priority::TaggedSymbol
          )
        NORMAL =
          T.let(
            :normal,
      ...
      class ReceivingAccount < ModernTreasury::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T.nilable(
              T::Array[
                ModernTreasury::PaymentOrderAsyncCreate::ReceivingAccount::AccountDetail
              ]
            )
          )
        end
        ...
        sig do
          params(
            account_details:
              T::Array[
                ModernTreasury::PaymentOrderAsyncCreate::ReceivingAccount::AccountDetail::OrHash
              ]
          ).void
        end
        ...
        sig do
          returns(
            T.nilable(
              ModernTreasury::PaymentOrderAsyncCreate::ReceivingAccount::PartyType::OrSymbol
            )
          )
        end
        ...
        sig do
          returns(
            T.nilable(
              T::Array[
                ModernTreasury::PaymentOrderAsyncCreate::ReceivingAccount::RoutingDetail
              ]
            )
          )
        end
        ...
        sig do
          params(
            routing_details:
              T::Array[
                ModernTreasury::PaymentOrderAsyncCreate::ReceivingAccount::RoutingDetail::OrHash
              ]
          ).void
        end
        ...
        class AccountDetail < ModernTreasury::Internal::Type::BaseModel
          ...
          sig do
            returns(
              T.nilable(
                ModernTreasury::PaymentOrderAsyncCreate::ReceivingAccount::AccountDetail::AccountNumberType::OrSymbol
              )
            )
          end
          ...
          module AccountNumberType
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  ModernTreasury::PaymentOrderAsyncCreate::ReceivingAccount::AccountDetail::AccountNumberType
                )
              end
            OrSymbol = T.type_alias { T.any(Symbol, String) }
            ...
            AU_NUMBER =
              T.let(
                :au_number,
                ModernTreasury::PaymentOrderAsyncCreate::ReceivingAccount::AccountDetail::AccountNumberType::TaggedSymbol
              )
            BASE_ADDRESS =
              T.let(
                :base_address,
        ...
        module PartyType
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                ModernTreasury::PaymentOrderAsyncCreate::ReceivingAccount::PartyType
              )
            end
          OrSymbol = T.type_alias { T.any(Symbol, String) }
          ...
          BUSINESS =
            T.let(
              :business,
              ModernTreasury::PaymentOrderAsyncCreate::ReceivingAccount::PartyType::TaggedSymbol
            )
          INDIVIDUAL =
            T.let(
              :individual,
        ...
        class RoutingDetail < ModernTreasury::Internal::Type::BaseModel
          ...
          sig do
            returns(
              ModernTreasury::PaymentOrderAsyncCreate::ReceivingAccount::RoutingDetail::RoutingNumberType::OrSymbol
            )
          end
          ...
          sig do
            returns(
              T.nilable(
                ModernTreasury::PaymentOrderAsyncCreate::ReceivingAccount::RoutingDetail::PaymentType::OrSymbol
              )
            )
          end
          ...
          module RoutingNumberType
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  ModernTreasury::PaymentOrderAsyncCreate::ReceivingAccount::RoutingDetail::RoutingNumberType
                )
              end
            OrSymbol = T.type_alias { T.any(Symbol, String) }
            ...
            ABA =
              T.let(
                :aba,
                ModernTreasury::PaymentOrderAsyncCreate::ReceivingAccount::RoutingDetail::RoutingNumberType::TaggedSymbol
              )
            AU_BSB =
              T.let(
                :au_bsb,
          ...
          module PaymentType
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  ModernTreasury::PaymentOrderAsyncCreate::ReceivingAccount::RoutingDetail::PaymentType
                )
              end
            OrSymbol = T.type_alias { T.any(Symbol, String) }
            ...
            ACH =
              T.let(
                :ach,
                ModernTreasury::PaymentOrderAsyncCreate::ReceivingAccount::RoutingDetail::PaymentType::TaggedSymbol
              )
            AU_BECS =
              T.let(
                :au_becs,
      ...
      module ReconciliationStatus
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(
              Symbol,
              ModernTreasury::PaymentOrderAsyncCreate::ReconciliationStatus
            )
          end
        OrSymbol = T.type_alias { T.any(Symbol, String) }
        ...
        UNRECONCILED =
          T.let(
            :unreconciled,
            ModernTreasury::PaymentOrderAsyncCreate::ReconciliationStatus::TaggedSymbol
          )
