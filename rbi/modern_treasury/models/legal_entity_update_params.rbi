...
module ModernTreasury
  module Models
    class LegalEntityUpdateParams < ModernTreasury::Internal::Type::BaseModel
      ...
      sig do
        returns(T.nilable(ModernTreasury::LegalEntityUpdateParams::TermsOfUse))
      end
      ...
      module BankSettings
        ...
        sig do
          override.returns(
            T::Array[
              ModernTreasury::LegalEntityUpdateParams::BankSettings::Variants
            ]
          )
        end
        def self.variants
      ...
      module BusinessDesignation
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(
              Symbol,
              ModernTreasury::LegalEntityUpdateParams::BusinessDesignation
            )
          end
        ...
        EXEMPT_FINANCIAL_INSTITUTION =
          T.let(
            :exempt_financial_institution,
            ModernTreasury::LegalEntityUpdateParams::BusinessDesignation::TaggedSymbol
          )
      ...
      class TermsOfUse < ModernTreasury::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              ModernTreasury::LegalEntityUpdateParams::TermsOfUse,
              ModernTreasury::Internal::AnyHash
            )
          end
      ...
      module ThirdPartyVerification
        ...
        sig do
          override.returns(
            T::Array[
              ModernTreasury::LegalEntityUpdateParams::ThirdPartyVerification::Variants
            ]
          )
        end
        def self.variants
      ...
      module WealthAndEmploymentDetails
        ...
        sig do
          override.returns(
            T::Array[
              ModernTreasury::LegalEntityUpdateParams::WealthAndEmploymentDetails::Variants
            ]
          )
        end
        def self.variants
