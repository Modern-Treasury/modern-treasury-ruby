...
module ModernTreasury
  module Models
    class ExpectedPaymentCreate < ModernTreasury::Internal::Type::BaseModel
      ...
      sig do
        returns(
          T.nilable(ModernTreasury::ExpectedPaymentCreate::Direction::OrSymbol)
        )
      end
      ...
      module AmountReconciledDirection
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(
              Symbol,
              ModernTreasury::ExpectedPaymentCreate::AmountReconciledDirection
            )
          end
        ...
        CREDIT =
          T.let(
            :credit,
            ModernTreasury::ExpectedPaymentCreate::AmountReconciledDirection::TaggedSymbol
          )
        DEBIT =
          T.let(
            :debit,
      ...
      module AmountUnreconciledDirection
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(
              Symbol,
              ModernTreasury::ExpectedPaymentCreate::AmountUnreconciledDirection
            )
          end
        OrSymbol = T.type_alias { T.any(Symbol, String) }
        ...
        CREDIT =
          T.let(
            :credit,
            ModernTreasury::ExpectedPaymentCreate::AmountUnreconciledDirection::TaggedSymbol
          )
        DEBIT =
          T.let(
            :debit,
      ...
      module Direction
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(Symbol, ModernTreasury::ExpectedPaymentCreate::Direction)
          end
        OrSymbol = T.type_alias { T.any(Symbol, String) }
        ...
        CREDIT =
          T.let(
            :credit,
            ModernTreasury::ExpectedPaymentCreate::Direction::TaggedSymbol
          )
        DEBIT =
          T.let(
            :debit,
