  ...
  module Models
    module InternalAccounts
      class BalanceReport < ModernTreasury::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T::Array[ModernTreasury::InternalAccounts::BalanceReport::Balance]
          )
        end
        ...
        sig do
          params(
            ...
            balances:
              T::Array[
                ModernTreasury::InternalAccounts::BalanceReport::Balance::OrHash
              ],
            created_at: Time,
        ...
        module BalanceReportType
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                ModernTreasury::InternalAccounts::BalanceReport::BalanceReportType
              )
            end
        ...
        class Balance < ModernTreasury::Internal::Type::BaseModel
          ...
          sig do
            returns(
              ModernTreasury::InternalAccounts::BalanceReport::Balance::BalanceType::TaggedSymbol
            )
          end
          ...
          sig do
            params(
              ...
              as_of_time: T.nilable(Time),
              balance_type:
                ModernTreasury::InternalAccounts::BalanceReport::Balance::BalanceType::OrSymbol,
              created_at: Time,
