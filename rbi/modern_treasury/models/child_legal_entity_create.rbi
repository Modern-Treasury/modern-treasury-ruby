  ...
  module Models
    class ChildLegalEntityCreate < ModernTreasury::Internal::Type::BaseModel
      ...
      sig do
        returns(
          T.nilable(
            ModernTreasury::ChildLegalEntityCreate::BusinessDesignation::OrSymbol
          )
        )
      end
      ...
      module BankSettings
        ...
        sig do
          override.returns(
            T::Array[
              ModernTreasury::ChildLegalEntityCreate::BankSettings::Variants
            ]
          )
        end
        def self.variants
      ...
      module BusinessDesignation
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(
              Symbol,
              ModernTreasury::ChildLegalEntityCreate::BusinessDesignation
            )
          end
        ...
        EXEMPT_FINANCIAL_INSTITUTION =
          T.let(
            :exempt_financial_institution,
            ModernTreasury::ChildLegalEntityCreate::BusinessDesignation::TaggedSymbol
          )
      ...
      module ThirdPartyVerification
        ...
        sig do
          override.returns(
            T::Array[
              ModernTreasury::ChildLegalEntityCreate::ThirdPartyVerification::Variants
            ]
          )
        end
        def self.variants
      ...
      module WealthAndEmploymentDetails
        ...
        sig do
          override.returns(
            T::Array[
              ModernTreasury::ChildLegalEntityCreate::WealthAndEmploymentDetails::Variants
            ]
          )
        end
        def self.variants
