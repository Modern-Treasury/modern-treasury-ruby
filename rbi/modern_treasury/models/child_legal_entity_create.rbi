  ...
  module Models
    class ChildLegalEntityCreate < ModernTreasury::Internal::Type::BaseModel
      ...
      class ThirdPartyVerification < ModernTreasury::Internal::Type::BaseModel
        ...
        sig do
          returns(
            ModernTreasury::ChildLegalEntityCreate::ThirdPartyVerification::Outcome::OrSymbol
          )
        end
        ...
        sig do
          returns(
            ModernTreasury::ChildLegalEntityCreate::ThirdPartyVerification::VerificationCategory::OrSymbol
          )
        end
        ...
        module Outcome
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                ModernTreasury::ChildLegalEntityCreate::ThirdPartyVerification::Outcome
              )
            end
          OrSymbol = T.type_alias { T.any(Symbol, String) }
          ...
          PASSED =
            T.let(
              :passed,
              ModernTreasury::ChildLegalEntityCreate::ThirdPartyVerification::Outcome::TaggedSymbol
            )
          FAILED =
            T.let(
              :failed,
        ...
        module VerificationCategory
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                ModernTreasury::ChildLegalEntityCreate::ThirdPartyVerification::VerificationCategory
              )
            end
          OrSymbol = T.type_alias { T.any(Symbol, String) }
          ...
          LEGAL_NAME =
            T.let(
              :legal_name,
              ModernTreasury::ChildLegalEntityCreate::ThirdPartyVerification::VerificationCategory::TaggedSymbol
            )
          DATE_OF_BIRTH =
            T.let(
              :date_of_birth,
