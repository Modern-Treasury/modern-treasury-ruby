...
module ModernTreasury
  module Models
    class LegalEntityCreateParams < ModernTreasury::Internal::Type::BaseModel
      ...
      sig do
        returns(
          T.nilable(T.any(ModernTreasury::LegalEntityBankSettings, T.anything))
        )
      end
      ...
      sig do
        returns(
          T.nilable(T::Array[ModernTreasury::LegalEntityCreateParams::Document])
        )
      end
      ...
      sig do
        returns(T.nilable(ModernTreasury::LegalEntityCreateParams::TermsOfUse))
      end
      ...
      sig do
        returns(
          T.nilable(
            T.any(ModernTreasury::LegalEntityWealthEmploymentDetail, T.anything)
          )
        )
      end
        ...
        override.returns(
          {
            ...
            date_of_birth: T.nilable(Date),
            documents:
              T::Array[ModernTreasury::LegalEntityCreateParams::Document],
            doing_business_as_names: T::Array[String],
            email: T.nilable(String),
            expected_activity_volume: T.nilable(Integer),
            external_id: T.nilable(String),
      ...
      module BankSettings
        ...
        sig do
          override.returns(
            T::Array[
              ModernTreasury::LegalEntityCreateParams::BankSettings::Variants
            ]
          )
        end
        def self.variants
      ...
      module BusinessDesignation
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(
              Symbol,
              ModernTreasury::LegalEntityCreateParams::BusinessDesignation
            )
          end
        OrSymbol = T.type_alias { T.any(Symbol, String) }
        ...
        EXEMPT_FINANCIAL_INSTITUTION =
          T.let(
            :exempt_financial_institution,
            ModernTreasury::LegalEntityCreateParams::BusinessDesignation::TaggedSymbol
          )
      ...
      class Document < ModernTreasury::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              ModernTreasury::LegalEntityCreateParams::Document,
              ModernTreasury::Internal::AnyHash
            )
          end
        ...
        sig do
          returns(
            ModernTreasury::LegalEntityCreateParams::Document::DocumentType::OrSymbol
          )
        end
        ...
        module DocumentType
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                ModernTreasury::LegalEntityCreateParams::Document::DocumentType
              )
            end
          OrSymbol = T.type_alias { T.any(Symbol, String) }
          ...
          ARTICLES_OF_INCORPORATION =
            T.let(
              :articles_of_incorporation,
              ModernTreasury::LegalEntityCreateParams::Document::DocumentType::TaggedSymbol
            )
      ...
      class TermsOfUse < ModernTreasury::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              ModernTreasury::LegalEntityCreateParams::TermsOfUse,
              ModernTreasury::Internal::AnyHash
            )
          end
      ...
      module ThirdPartyVerification
        ...
        sig do
          override.returns(
            T::Array[
              ModernTreasury::LegalEntityCreateParams::ThirdPartyVerification::Variants
            ]
          )
        end
        def self.variants
      ...
      module WealthAndEmploymentDetails
        ...
        sig do
          override.returns(
            T::Array[
              ModernTreasury::LegalEntityCreateParams::WealthAndEmploymentDetails::Variants
            ]
          )
        end
        def self.variants
