  ...
  module Models
    class LineItemUpdateResponse < ModernTreasury::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(
            ModernTreasury::Models::LineItemUpdateResponse,
      ...
      sig do
        returns(
          ModernTreasury::Models::LineItemUpdateResponse::ItemizableType::TaggedSymbol
        )
      end
      ...
      sig do
        params(
          ...
          itemizable_type:
            ModernTreasury::Models::LineItemUpdateResponse::ItemizableType::OrSymbol,
          live_mode: T::Boolean,
      ...
      module ItemizableType
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(
              Symbol,
              ModernTreasury::Models::LineItemUpdateResponse::ItemizableType
            )
          end
