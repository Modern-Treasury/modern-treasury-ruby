      ...
      class LegalEntity < ModernTreasury::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T.nilable(
              T::Array[
                ModernTreasury::CounterpartyCreateParams::LegalEntity::Document
              ]
            )
          )
        end
        ...
        sig do
          params(
            documents:
              T::Array[
                ModernTreasury::CounterpartyCreateParams::LegalEntity::Document::OrHash
              ]
          ).void
        end
        ...
        class Document < ModernTreasury::Internal::Type::BaseModel
          ...
          sig do
            returns(
              ModernTreasury::CounterpartyCreateParams::LegalEntity::Document::DocumentType::OrSymbol
            )
          end
          ...
          module DocumentType
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  ModernTreasury::CounterpartyCreateParams::LegalEntity::Document::DocumentType
                )
              end
            OrSymbol = T.type_alias { T.any(Symbol, String) }
            ...
            ARTICLES_OF_INCORPORATION =
              T.let(
                :articles_of_incorporation,
                ModernTreasury::CounterpartyCreateParams::LegalEntity::Document::DocumentType::TaggedSymbol
              )
        ...
        class ThirdPartyVerification < ModernTreasury::Internal::Type::BaseModel
          ...
          sig do
            returns(
              ModernTreasury::CounterpartyCreateParams::LegalEntity::ThirdPartyVerification::Outcome::OrSymbol
            )
          end
          ...
          sig do
            returns(
              ModernTreasury::CounterpartyCreateParams::LegalEntity::ThirdPartyVerification::VerificationCategory::OrSymbol
            )
          end
          ...
          module Outcome
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  ModernTreasury::CounterpartyCreateParams::LegalEntity::ThirdPartyVerification::Outcome
                )
              end
            OrSymbol = T.type_alias { T.any(Symbol, String) }
            ...
            PASSED =
              T.let(
                :passed,
                ModernTreasury::CounterpartyCreateParams::LegalEntity::ThirdPartyVerification::Outcome::TaggedSymbol
              )
            FAILED =
              T.let(
                :failed,
          ...
          module VerificationCategory
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  ModernTreasury::CounterpartyCreateParams::LegalEntity::ThirdPartyVerification::VerificationCategory
                )
              end
            OrSymbol = T.type_alias { T.any(Symbol, String) }
            ...
            LEGAL_NAME =
              T.let(
                :legal_name,
                ModernTreasury::CounterpartyCreateParams::LegalEntity::ThirdPartyVerification::VerificationCategory::TaggedSymbol
              )
            DATE_OF_BIRTH =
              T.let(
                :date_of_birth,
