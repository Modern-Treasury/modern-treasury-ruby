  ...
  module Models
    class ExpectedPaymentUpdate < ModernTreasury::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(
            ModernTreasury::ExpectedPaymentUpdate,
      ...
      sig do
        returns(
          T.nilable(ModernTreasury::ExpectedPaymentUpdate::Direction::OrSymbol)
        )
      end
        ...
        override.returns(
          {
            ...
            status:
              T.nilable(
                ModernTreasury::ExpectedPaymentUpdate::Status::OrSymbol
              ),
            type: T.nilable(ModernTreasury::ExpectedPaymentType::OrSymbol)
          }
        )
      ...
      module AmountReconciledDirection
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(
              Symbol,
              ModernTreasury::ExpectedPaymentUpdate::AmountReconciledDirection
            )
          end
        ...
        CREDIT =
          T.let(
            :credit,
            ModernTreasury::ExpectedPaymentUpdate::AmountReconciledDirection::TaggedSymbol
          )
        DEBIT =
          T.let(
            :debit,
      ...
      module AmountUnreconciledDirection
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(
              Symbol,
              ModernTreasury::ExpectedPaymentUpdate::AmountUnreconciledDirection
            )
          end
        OrSymbol = T.type_alias { T.any(Symbol, String) }
        ...
        CREDIT =
          T.let(
            :credit,
            ModernTreasury::ExpectedPaymentUpdate::AmountUnreconciledDirection::TaggedSymbol
          )
        DEBIT =
          T.let(
            :debit,
      ...
      module Direction
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(Symbol, ModernTreasury::ExpectedPaymentUpdate::Direction)
          end
        OrSymbol = T.type_alias { T.any(Symbol, String) }
        ...
        CREDIT =
          T.let(
            :credit,
            ModernTreasury::ExpectedPaymentUpdate::Direction::TaggedSymbol
          )
        DEBIT =
          T.let(
            :debit,
      ...
      module Status
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(Symbol, ModernTreasury::ExpectedPaymentUpdate::Status)
          end
        OrSymbol = T.type_alias { T.any(Symbol, String) }
        ...
        RECONCILED =
          T.let(
            :reconciled,
            ModernTreasury::ExpectedPaymentUpdate::Status::TaggedSymbol
          )
