  ...
  module Models
    class Identification < ModernTreasury::Internal::Type::BaseModel
      ...
      module IDType
        ...
        QA_QID =
          T.let(:qa_qid, ModernTreasury::Identification::IDType::TaggedSymbol)
        QA_TIN =
          T.let(:qa_tin, ModernTreasury::Identification::IDType::TaggedSymbol)
        RO_CNP =
        ...
        RW_TIN =
          T.let(:rw_tin, ModernTreasury::Identification::IDType::TaggedSymbol)
        SA_TIN =
        ...
        SL_TIN =
          T.let(:sl_tin, ModernTreasury::Identification::IDType::TaggedSymbol)
        SM_SSI =
          T.let(:sm_ssi, ModernTreasury::Identification::IDType::TaggedSymbol)
        SZ_TIN =
          T.let(:sz_tin, ModernTreasury::Identification::IDType::TaggedSymbol)
        TG_NIF =
          T.let(:tg_nif, ModernTreasury::Identification::IDType::TaggedSymbol)
        TH_JID =
          T.let(:th_jid, ModernTreasury::Identification::IDType::TaggedSymbol)
        TH_PIN =
          T.let(:th_pin, ModernTreasury::Identification::IDType::TaggedSymbol)
        TJ_INN =
          T.let(:tj_inn, ModernTreasury::Identification::IDType::TaggedSymbol)
        TO_TIN =
          T.let(:to_tin, ModernTreasury::Identification::IDType::TaggedSymbol)
        TR_TCKN =
          T.let(:tr_tckn, ModernTreasury::Identification::IDType::TaggedSymbol)
        TT_BIR =
          T.let(:tt_bir, ModernTreasury::Identification::IDType::TaggedSymbol)
        TW_NRIC =
          T.let(:tw_nric, ModernTreasury::Identification::IDType::TaggedSymbol)
        TW_UBN =
          T.let(:tw_ubn, ModernTreasury::Identification::IDType::TaggedSymbol)
        UG_TIN =
          T.let(:ug_tin, ModernTreasury::Identification::IDType::TaggedSymbol)
        US_EIN =
        ...
        UZ_INN =
          T.let(:uz_inn, ModernTreasury::Identification::IDType::TaggedSymbol)
        UZ_PIN =
          T.let(:uz_pin, ModernTreasury::Identification::IDType::TaggedSymbol)
        VN_TIN =
          T.let(:vn_tin, ModernTreasury::Identification::IDType::TaggedSymbol)
        ZA_TRN =
          T.let(:za_trn, ModernTreasury::Identification::IDType::TaggedSymbol)
        ZA_VAT =
          T.let(:za_vat, ModernTreasury::Identification::IDType::TaggedSymbol)
        ZM_TPIN =
          T.let(:zm_tpin, ModernTreasury::Identification::IDType::TaggedSymbol)
