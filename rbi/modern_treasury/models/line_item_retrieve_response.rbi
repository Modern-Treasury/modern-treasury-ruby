  ...
  module Models
    class LineItemRetrieveResponse < ModernTreasury::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(
            ModernTreasury::Models::LineItemRetrieveResponse,
      ...
      sig do
        returns(
          ModernTreasury::Models::LineItemRetrieveResponse::ItemizableType::TaggedSymbol
        )
      end
      ...
      sig do
        params(
          ...
          itemizable_type:
            ModernTreasury::Models::LineItemRetrieveResponse::ItemizableType::OrSymbol,
          live_mode: T::Boolean,
      ...
      module ItemizableType
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(
              Symbol,
              ModernTreasury::Models::LineItemRetrieveResponse::ItemizableType
            )
          end
