  ...
  module Models
    class PaymentOrderUpdate < ModernTreasury::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(
            ModernTreasury::PaymentOrderUpdate,
      ...
      sig do
        returns(
          T.nilable(ModernTreasury::PaymentOrderUpdate::ChargeBearer::OrSymbol)
        )
      end
      ...
      sig do
        returns(
          T.nilable(ModernTreasury::PaymentOrderUpdate::Direction::OrSymbol)
        )
      end
      ...
      sig do
        returns(
          T.nilable(ModernTreasury::PaymentOrderUpdate::FallbackType::OrSymbol)
        )
      end
      ...
      sig do
        returns(
          T.nilable(ModernTreasury::PaymentOrderUpdate::Priority::OrSymbol)
        )
      end
      ...
      # internal account.
      sig do
        returns(T.nilable(ModernTreasury::PaymentOrderUpdate::ReceivingAccount))
      end
      ...
      # `needs_approval`.
      sig do
        returns(T.nilable(ModernTreasury::PaymentOrderUpdate::Status::OrSymbol))
      end
      attr_reader :status
        ...
        override.returns(
          {
            ...
            purpose: T.nilable(String),
            receiving_account:
              ModernTreasury::PaymentOrderUpdate::ReceivingAccount,
            receiving_account_id: String,
            reconciliation_status:
              ModernTreasury::PaymentOrderUpdate::ReconciliationStatus::OrSymbol,
            remittance_information: T.nilable(String),
      ...
      module ChargeBearer
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(Symbol, ModernTreasury::PaymentOrderUpdate::ChargeBearer)
          end
        ...
        SHARED =
          T.let(
            :shared,
            ModernTreasury::PaymentOrderUpdate::ChargeBearer::TaggedSymbol
          )
        SENDER =
          T.let(
            :sender,
      ...
      module Direction
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(Symbol, ModernTreasury::PaymentOrderUpdate::Direction)
          end
        OrSymbol = T.type_alias { T.any(Symbol, String) }
        ...
        CREDIT =
          T.let(
            :credit,
            ModernTreasury::PaymentOrderUpdate::Direction::TaggedSymbol
          )
        DEBIT =
          T.let(
            :debit,
      ...
      module FallbackType
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(Symbol, ModernTreasury::PaymentOrderUpdate::FallbackType)
          end
        OrSymbol = T.type_alias { T.any(Symbol, String) }
        ...
        ACH =
          T.let(
            :ach,
            ModernTreasury::PaymentOrderUpdate::FallbackType::TaggedSymbol
          )
      ...
      module ForeignExchangeIndicator
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(
              Symbol,
              ModernTreasury::PaymentOrderUpdate::ForeignExchangeIndicator
            )
          end
        OrSymbol = T.type_alias { T.any(Symbol, String) }
        ...
        FIXED_TO_VARIABLE =
          T.let(
            :fixed_to_variable,
            ModernTreasury::PaymentOrderUpdate::ForeignExchangeIndicator::TaggedSymbol
          )
        VARIABLE_TO_FIXED =
          T.let(
            :variable_to_fixed,
      ...
      module Priority
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(Symbol, ModernTreasury::PaymentOrderUpdate::Priority)
          end
        OrSymbol = T.type_alias { T.any(Symbol, String) }
        ...
        HIGH =
          T.let(
            :high,
            ModernTreasury::PaymentOrderUpdate::Priority::TaggedSymbol
          )
        NORMAL =
          T.let(
            :normal,
        ...
        sig do
          override.returns(
            T::Array[ModernTreasury::PaymentOrderUpdate::Priority::TaggedSymbol]
          )
        end
        def self.values
        end
      ...
      class ReceivingAccount < ModernTreasury::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T.nilable(
              T::Array[
                ModernTreasury::PaymentOrderUpdate::ReceivingAccount::AccountDetail
              ]
            )
          )
        end
        ...
        sig do
          params(
            account_details:
              T::Array[
                ModernTreasury::PaymentOrderUpdate::ReceivingAccount::AccountDetail::OrHash
              ]
          ).void
        end
        ...
        sig do
          returns(
            T.nilable(
              ModernTreasury::PaymentOrderUpdate::ReceivingAccount::PartyType::OrSymbol
            )
          )
        end
        ...
        sig do
          returns(
            T.nilable(
              T::Array[
                ModernTreasury::PaymentOrderUpdate::ReceivingAccount::RoutingDetail
              ]
            )
          )
        end
        ...
        sig do
          params(
            routing_details:
              T::Array[
                ModernTreasury::PaymentOrderUpdate::ReceivingAccount::RoutingDetail::OrHash
              ]
          ).void
        end
        ...
        class AccountDetail < ModernTreasury::Internal::Type::BaseModel
          ...
          sig do
            returns(
              T.nilable(
                ModernTreasury::PaymentOrderUpdate::ReceivingAccount::AccountDetail::AccountNumberType::OrSymbol
              )
            )
          end
          ...
          module AccountNumberType
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  ModernTreasury::PaymentOrderUpdate::ReceivingAccount::AccountDetail::AccountNumberType
                )
              end
            OrSymbol = T.type_alias { T.any(Symbol, String) }
            ...
            AU_NUMBER =
              T.let(
                :au_number,
                ModernTreasury::PaymentOrderUpdate::ReceivingAccount::AccountDetail::AccountNumberType::TaggedSymbol
              )
            BASE_ADDRESS =
              T.let(
                :base_address,
        ...
        module PartyType
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                ModernTreasury::PaymentOrderUpdate::ReceivingAccount::PartyType
              )
            end
          OrSymbol = T.type_alias { T.any(Symbol, String) }
          ...
          BUSINESS =
            T.let(
              :business,
              ModernTreasury::PaymentOrderUpdate::ReceivingAccount::PartyType::TaggedSymbol
            )
          INDIVIDUAL =
            T.let(
              :individual,
        ...
        class RoutingDetail < ModernTreasury::Internal::Type::BaseModel
          ...
          sig do
            returns(
              ModernTreasury::PaymentOrderUpdate::ReceivingAccount::RoutingDetail::RoutingNumberType::OrSymbol
            )
          end
          ...
          sig do
            returns(
              T.nilable(
                ModernTreasury::PaymentOrderUpdate::ReceivingAccount::RoutingDetail::PaymentType::OrSymbol
              )
            )
          end
          ...
          module RoutingNumberType
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  ModernTreasury::PaymentOrderUpdate::ReceivingAccount::RoutingDetail::RoutingNumberType
                )
              end
            OrSymbol = T.type_alias { T.any(Symbol, String) }
            ...
            ABA =
              T.let(
                :aba,
                ModernTreasury::PaymentOrderUpdate::ReceivingAccount::RoutingDetail::RoutingNumberType::TaggedSymbol
              )
            AU_BSB =
              T.let(
                :au_bsb,
          ...
          module PaymentType
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  ModernTreasury::PaymentOrderUpdate::ReceivingAccount::RoutingDetail::PaymentType
                )
              end
            OrSymbol = T.type_alias { T.any(Symbol, String) }
            ...
            ACH =
              T.let(
                :ach,
                ModernTreasury::PaymentOrderUpdate::ReceivingAccount::RoutingDetail::PaymentType::TaggedSymbol
              )
            AU_BECS =
              T.let(
                :au_becs,
      ...
      module ReconciliationStatus
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(
              Symbol,
              ModernTreasury::PaymentOrderUpdate::ReconciliationStatus
            )
          end
        OrSymbol = T.type_alias { T.any(Symbol, String) }
        ...
        UNRECONCILED =
          T.let(
            :unreconciled,
            ModernTreasury::PaymentOrderUpdate::ReconciliationStatus::TaggedSymbol
          )
      ...
      module Status
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(Symbol, ModernTreasury::PaymentOrderUpdate::Status)
          end
        OrSymbol = T.type_alias { T.any(Symbol, String) }
        ...
        APPROVED =
          T.let(
            :approved,
            ModernTreasury::PaymentOrderUpdate::Status::TaggedSymbol
          )
        CANCELLED =
          T.let(
            :cancelled,
        ...
        HELD =
          T.let(:held, ModernTreasury::PaymentOrderUpdate::Status::TaggedSymbol)
        NEEDS_APPROVAL =
          T.let(
            :needs_approval,
            ModernTreasury::PaymentOrderUpdate::Status::TaggedSymbol
        ...
        SENT =
          T.let(:sent, ModernTreasury::PaymentOrderUpdate::Status::TaggedSymbol)
        STOPPED =
          T.let(
            :stopped,
            ModernTreasury::PaymentOrderUpdate::Status::TaggedSymbol
        ...
        sig do
          override.returns(
            T::Array[ModernTreasury::PaymentOrderUpdate::Status::TaggedSymbol]
          )
        end
        def self.values
        end
