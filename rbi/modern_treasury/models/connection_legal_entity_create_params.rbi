    ...
    class ConnectionLegalEntityCreateParams < ModernTreasury::Internal::Type::BaseModel
      ...
      class LegalEntity < ModernTreasury::Internal::Type::BaseModel
        ...
        class ThirdPartyVerification < ModernTreasury::Internal::Type::BaseModel
          ...
          sig do
            returns(
              ModernTreasury::ConnectionLegalEntityCreateParams::LegalEntity::ThirdPartyVerification::Outcome::OrSymbol
            )
          end
          ...
          sig do
            returns(
              ModernTreasury::ConnectionLegalEntityCreateParams::LegalEntity::ThirdPartyVerification::VerificationCategory::OrSymbol
            )
          end
          ...
          module Outcome
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  ModernTreasury::ConnectionLegalEntityCreateParams::LegalEntity::ThirdPartyVerification::Outcome
                )
              end
            OrSymbol = T.type_alias { T.any(Symbol, String) }
            ...
            PASSED =
              T.let(
                :passed,
                ModernTreasury::ConnectionLegalEntityCreateParams::LegalEntity::ThirdPartyVerification::Outcome::TaggedSymbol
              )
            FAILED =
              T.let(
                :failed,
          ...
          module VerificationCategory
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  ModernTreasury::ConnectionLegalEntityCreateParams::LegalEntity::ThirdPartyVerification::VerificationCategory
                )
              end
            OrSymbol = T.type_alias { T.any(Symbol, String) }
            ...
            LEGAL_NAME =
              T.let(
                :legal_name,
                ModernTreasury::ConnectionLegalEntityCreateParams::LegalEntity::ThirdPartyVerification::VerificationCategory::TaggedSymbol
              )
            DATE_OF_BIRTH =
              T.let(
                :date_of_birth,
