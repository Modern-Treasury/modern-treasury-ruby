      ...
      class LegalEntity < ModernTreasury::Internal::Type::BaseModel
        ...
        sig do
          params(
            terms_of_use:
              T.nilable(
                ModernTreasury::ConnectionLegalEntityCreateParams::LegalEntity::TermsOfUse::OrHash
              )
          ).void
        end
        ...
        module BankSettings
          ...
          sig do
            override.returns(
              T::Array[
                ModernTreasury::ConnectionLegalEntityCreateParams::LegalEntity::BankSettings::Variants
              ]
            )
          end
          def self.variants
        ...
        module ThirdPartyVerification
          ...
          sig do
            override.returns(
              T::Array[
                ModernTreasury::ConnectionLegalEntityCreateParams::LegalEntity::ThirdPartyVerification::Variants
              ]
            )
          end
          def self.variants
        ...
        module WealthAndEmploymentDetails
          ...
          sig do
            override.returns(
              T::Array[
                ModernTreasury::ConnectionLegalEntityCreateParams::LegalEntity::WealthAndEmploymentDetails::Variants
              ]
            )
          end
          def self.variants
