  ...
  module Internal
    ...
    module Util
      ...
      class << self
        # @api private
        sig do
          params(query: ModernTreasury::Internal::AnyHash).returns(
            ModernTreasury::Internal::AnyHash
          )
        end
        ...
        sig do
          params(
            collection: ModernTreasury::Internal::AnyHash,
            key: String,
            element: T.anything
          ).void
        end
      ...
      class << self
        ...
        sig do
          params(lines: T::Enumerable[String]).returns(
            T::Enumerable[ModernTreasury::Internal::Util::ServerSentEvent]
          )
        end
        ...
        class << self
          ...
          sig do
            params(
              type:
                T.any(
                  ModernTreasury::Internal::Util::SorbetRuntimeSupport,
                  T.anything
                )
            ).returns(T.anything)
          end
