    ...
    class PooledNetRequester
      ...
      class << self
        ...
        def build_request(request, &blk)
          ...
          in String
            ...
            req.body_stream = ModernTreasury::Util::ReadIOAdapter.new(body, &blk)
          in StringIO
      ...
      def execute(request)
        ...
        enum = Enumerator.new do |y|
          ...
          raise ModernTreasury::APITimeoutError
        end

        conn, _, response = enum.next
        body = ModernTreasury::Util.fused_enum(enum, external: true) do
          finished = true
          tap do
            enum.next
