...
module ModernTreasury
  module Transport
    ...
    class BaseClient
      ...
      # @api private
      # @return [ModernTreasury::Transport::PooledNetRequester]
      ...
      def initialize(
        ...
        @requester = ModernTreasury::Transport::PooledNetRequester.new
      ...
      #
      #   @option req [ModernTreasury::Type::Converter, Class, nil] :model
      #
      ...
      private def build_request(req, opts)
        ...
        body =
          ...
          in :get | :head | :options | :trace
            ...
            ModernTreasury::Util.deep_merge(*[req[:body], opts[:extra_body]].compact)
          end
      ...
      private def send_request(request, redirect_count:, retry_count:, send_retry_header:)
        ...
        input = {**request.except(:timeout), deadline: ModernTreasury::Util.monotonic_secs + timeout}
        ...
        in (400..) if retry_count >= max_retries || !self.class.should_retry?(status, headers: response)
          decoded = Kernel.then do
            ModernTreasury::Util.decode_content(response, stream: stream, suppress_error: true)
          ensure
            self.class.reap_connection!(status, stream: stream)
          end
      ...
      def request(req)
        ...
        in { page: Class => page }
          ...
          ModernTreasury::Type::Converter.coerce(model, unwrapped)
        end
      end
