...
module ModernTreasury
  module Models
    class ExpectedPaymentUpdate < ModernTreasury::Internal::Type::BaseModel
      ...
      #   amount.
      #
      #   @return [Symbol, ModernTreasury::Models::ExpectedPaymentUpdate::AmountReconciledDirection, nil]
      optional :amount_reconciled_direction,
               enum: -> { ModernTreasury::ExpectedPaymentUpdate::AmountReconciledDirection },
               nil?: true
      ...
      #   debit amount.
      #
      #   @return [Symbol, ModernTreasury::Models::ExpectedPaymentUpdate::AmountUnreconciledDirection, nil]
      optional :amount_unreconciled_direction,
               enum: -> { ModernTreasury::ExpectedPaymentUpdate::AmountUnreconciledDirection },
               nil?: true
      ...
      #
      #   @return [Symbol, ModernTreasury::Models::ExpectedPaymentUpdate::Direction, nil]
      optional :direction, enum: -> { ModernTreasury::ExpectedPaymentUpdate::Direction }, nil?: true
      ...
      #   reconciled.
      #
      #   @return [Symbol, ModernTreasury::Models::ExpectedPaymentUpdate::Status, nil]
      optional :status, enum: -> { ModernTreasury::ExpectedPaymentUpdate::Status }, nil?: true
      ...
      #   {ModernTreasury::Models::ExpectedPaymentUpdate} for more details.
      #
      ...
      # amount.
      #
      # @see ModernTreasury::Models::ExpectedPaymentUpdate#amount_reconciled_direction
      ...
      # debit amount.
      #
      # @see ModernTreasury::Models::ExpectedPaymentUpdate#amount_unreconciled_direction
      ...
      # being charged, use debit.
      #
      # @see ModernTreasury::Models::ExpectedPaymentUpdate#direction
      module Direction
        extend ModernTreasury::Internal::Type::Enum
      ...
      # reconciled.
      #
      # @see ModernTreasury::Models::ExpectedPaymentUpdate#status
      module Status
        extend ModernTreasury::Internal::Type::Enum
