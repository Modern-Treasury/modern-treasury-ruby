...
module ModernTreasury
  module Models
    ...
    class LegalEntityCreateParams < ModernTreasury::Internal::Type::BaseModel
      ...
      optional :bank_settings, union: -> { ModernTreasury::LegalEntityCreateParams::BankSettings }
      ...
      #
      #   @return [Symbol, ModernTreasury::Models::LegalEntityCreateParams::BusinessDesignation, nil]
      optional :business_designation,
               enum: -> { ModernTreasury::LegalEntityCreateParams::BusinessDesignation },
               nil?: true
      ...
      #
      #   @return [Array<ModernTreasury::Models::LegalEntityCreateParams::Regulator>, nil]
      optional :regulators,
               -> {
                 ModernTreasury::Internal::Type::ArrayOf[ModernTreasury::LegalEntityCreateParams::Regulator]
               },
               nil?: true
      ...
      optional :third_party_verification,
               union: -> { ModernTreasury::LegalEntityCreateParams::ThirdPartyVerification }
      ...
      optional :wealth_and_employment_details,
               union: -> { ModernTreasury::LegalEntityCreateParams::WealthAndEmploymentDetails }
      ...
      class Regulator < ModernTreasury::Internal::Type::BaseModel
        ...
        #   Some parameter documentations has been truncated, see
        #   {ModernTreasury::Models::LegalEntityCreateParams::Regulator} for more details.
        #
