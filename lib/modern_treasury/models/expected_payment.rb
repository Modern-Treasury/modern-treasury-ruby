...
module ModernTreasury
  module Models
    ...
    class ExpectedPayment < ModernTreasury::Internal::Type::BaseModel
      ...
      # @!attribute currency
      #
      #   @return [Symbol, ModernTreasury::Models::ExpectedPayment::Currency, nil]
      required :currency, enum: -> { ModernTreasury::ExpectedPayment::Currency }, nil?: true
      ...
      #
      #   @param currency [Symbol, ModernTreasury::Models::ExpectedPayment::Currency, nil]
      #
      ...
      # @see ModernTreasury::Models::ExpectedPayment#currency
      module Currency
        extend ModernTreasury::Internal::Type::Enum
