...
module ModernTreasury
  module Models
    class ExpectedPaymentCreate < ModernTreasury::Internal::Type::BaseModel
      ...
      #   amount.
      #
      #   @return [Symbol, ModernTreasury::Models::ExpectedPaymentCreate::AmountReconciledDirection, nil]
      optional :amount_reconciled_direction,
               enum: -> { ModernTreasury::ExpectedPaymentCreate::AmountReconciledDirection },
               nil?: true
      ...
      #   debit amount.
      #
      #   @return [Symbol, ModernTreasury::Models::ExpectedPaymentCreate::AmountUnreconciledDirection, nil]
      optional :amount_unreconciled_direction,
               enum: -> { ModernTreasury::ExpectedPaymentCreate::AmountUnreconciledDirection },
               nil?: true
      ...
      #
      #   @return [Symbol, ModernTreasury::Models::ExpectedPaymentCreate::Direction, nil]
      optional :direction, enum: -> { ModernTreasury::ExpectedPaymentCreate::Direction }, nil?: true
      ...
      #   {ModernTreasury::Models::ExpectedPaymentCreate} for more details.
      #
      ...
      # amount.
      #
      # @see ModernTreasury::Models::ExpectedPaymentCreate#amount_reconciled_direction
      ...
      # debit amount.
      #
      # @see ModernTreasury::Models::ExpectedPaymentCreate#amount_unreconciled_direction
      ...
      # being charged, use debit.
      #
      # @see ModernTreasury::Models::ExpectedPaymentCreate#direction
      module Direction
        extend ModernTreasury::Internal::Type::Enum
