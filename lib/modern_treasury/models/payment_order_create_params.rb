...
module ModernTreasury
  module Models
    ...
    class PaymentOrderCreateParams < ModernTreasury::Internal::Type::BaseModel
      ...
      #
      #   @return [ModernTreasury::Models::PaymentOrderCreateParams::OriginatingPartyAddress, nil]
      ...
      #
      #   @return [ModernTreasury::Models::PaymentOrderCreateParams::UltimateOriginatingPartyAddress, nil]
      ...
      class OriginatingPartyAddress < ModernTreasury::Internal::Type::BaseModel
        ...
        #   Some parameter documentations has been truncated, see
        #   {ModernTreasury::Models::PaymentOrderCreateParams::OriginatingPartyAddress} for
        #   more details.
        #
        #   If present, this address will override the default originating party address
        #   used on the payment order. This works across all payment types.
