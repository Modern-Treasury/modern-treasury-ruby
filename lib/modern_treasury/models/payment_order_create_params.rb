...
module ModernTreasury
  module Models
    class PaymentOrderCreateParams < ModernTreasury::BaseModel
      ...
      # @!attribute [rw] receiving_account
      ...
      class Document < ModernTreasury::BaseModel
        ...
        #   #   @option data [String] :documentable_type
        #   #   @option data [String] :file
        #   #   @option data [String, nil] :document_type A category given to the document, can be `null`.
        #   def initialize(data = {}) = super
      end
