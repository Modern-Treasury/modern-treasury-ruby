  ...
  module Models
    ...
    class ConnectionLegalEntityCreateParams < ModernTreasury::Internal::Type::BaseModel
      ...
      class LegalEntity < ModernTreasury::Internal::Type::BaseModel
        ...
        #   # @param legal_entity_associations [Array<ModernTreasury::Models::ConnectionLegalEntityCreateParams::LegalEntity::LegalEntityAssociation>, nil]
        #   # @param legal_entity_type [Symbol, ModernTreasury::Models::ConnectionLegalEntityCreateParams::LegalEntity::LegalEntityType]
        #   # @param legal_structure [Symbol, ModernTreasury::Models::ConnectionLegalEntityCreateParams::LegalEntity::LegalStructure, nil]
        ...
        #   # @param risk_rating [Symbol, ModernTreasury::Models::ConnectionLegalEntityCreateParams::LegalEntity::RiskRating, nil]
        ...
        class Address < ModernTreasury::Internal::Type::BaseModel
          ...
          #   # @param address_types [Array<Symbol, ModernTreasury::Models::ConnectionLegalEntityCreateParams::LegalEntity::Address::AddressType>]
        ...
        class Identification < ModernTreasury::Internal::Type::BaseModel
          ...
          #   # @param id_type [Symbol, ModernTreasury::Models::ConnectionLegalEntityCreateParams::LegalEntity::Identification::IDType]
        ...
        class LegalEntityAssociation < ModernTreasury::Internal::Type::BaseModel
          ...
          class ChildLegalEntity < ModernTreasury::Internal::Type::BaseModel
            ...
            #   # @param industry_classifications [Array<ModernTreasury::Models::LegalEntityIndustryClassification>]
            #   # @param last_name [String, nil]
            #   # @param legal_entity_type [Symbol, ModernTreasury::Models::ConnectionLegalEntityCreateParams::LegalEntity::LegalEntityAssociation::ChildLegalEntity::LegalEntityType]
            #   # @param legal_structure [Symbol, ModernTreasury::Models::ConnectionLegalEntityCreateParams::LegalEntity::LegalEntityAssociation::ChildLegalEntity::LegalStructure, nil]
            #   # @param metadata [Hash{Symbol=>String}]
            #   # @param middle_name [String, nil]
            ...
            #   # @param preferred_name [String, nil]
            #   # @param prefix [String, nil]
            #   # @param risk_rating [Symbol, ModernTreasury::Models::ConnectionLegalEntityCreateParams::LegalEntity::LegalEntityAssociation::ChildLegalEntity::RiskRating, nil]
            #   # @param suffix [String, nil]
            #   # @param wealth_and_employment_details [ModernTreasury::Models::WealthAndEmploymentDetails, nil]
            #   # @param website [String, nil]
            #   #
            ...
            class Address < ModernTreasury::Internal::Type::BaseModel
              ...
              #   # @param postal_code [String, nil]
              #   # @param region [String, nil]
              #   # @param address_types [Array<Symbol, ModernTreasury::Models::ConnectionLegalEntityCreateParams::LegalEntity::LegalEntityAssociation::ChildLegalEntity::Address::AddressType>]
              #   # @param line2 [String, nil]
              #   #
              #   def initialize(country:, line1:, locality:, postal_code:, region:, address_types: nil, line2: nil, **) = super
            ...
            class Identification < ModernTreasury::Internal::Type::BaseModel
              ...
              # @!parse
              #   # @param id_number [String]
              #   # @param id_type [Symbol, ModernTreasury::Models::ConnectionLegalEntityCreateParams::LegalEntity::LegalEntityAssociation::ChildLegalEntity::Identification::IDType]
              #   # @param issuing_country [String, nil]
              #   #
              #   def initialize(id_number:, id_type:, issuing_country: nil, **) = super
