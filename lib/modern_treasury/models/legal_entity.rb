...
module ModernTreasury
  module Models
    ...
    class LegalEntity < ModernTreasury::Internal::Type::BaseModel
      ...
      required :bank_settings, union: -> { ModernTreasury::LegalEntity::BankSettings }
      ...
      required :third_party_verification, union: -> { ModernTreasury::LegalEntity::ThirdPartyVerification }
      ...
      required :wealth_and_employment_details,
               union: -> { ModernTreasury::LegalEntity::WealthAndEmploymentDetails }
      ...
      # @see ModernTreasury::Models::LegalEntity#bank_settings
      module BankSettings
      ...
      # @see ModernTreasury::Models::LegalEntity#wealth_and_employment_details
