...
module ModernTreasury
  module Models
    ...
    class PaymentOrderUpdateParams < ModernTreasury::Internal::Type::BaseModel
      ...
      #
      #   @return [ModernTreasury::Models::PaymentOrderUpdateParams::OriginatingPartyAddress, nil]
      ...
      class OriginatingPartyAddress < ModernTreasury::Internal::Type::BaseModel
        ...
        #   Some parameter documentations has been truncated, see
        #   {ModernTreasury::Models::PaymentOrderUpdateParams::OriginatingPartyAddress} for
        #   more details.
        #
        #   If present, this address will override the default originating party address
        #   used on the payment order. This works across all payment types.
