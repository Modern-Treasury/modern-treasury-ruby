    ...
    class BulkRequestCreateParams < ModernTreasury::Internal::Type::BaseModel
      ...
      module Resource
        ...
        class ExpectedPaymentCreateRequest < ModernTreasury::Internal::Type::BaseModel
          ...
          # @!attribute currency
          #
          #   @return [Symbol, ModernTreasury::Models::BulkRequestCreateParams::Resource::ExpectedPaymentCreateRequest::Currency, nil]
          optional :currency,
                   enum: -> {
          ...
          #
          #   @param currency [Symbol, ModernTreasury::Models::BulkRequestCreateParams::Resource::ExpectedPaymentCreateRequest::Currency, nil]
          #
          ...
          # @see ModernTreasury::Models::BulkRequestCreateParams::Resource::ExpectedPaymentCreateRequest#currency
          module Currency
            extend ModernTreasury::Internal::Type::Enum
        ...
        class ExpectedPaymentUpdateRequestWithID < ModernTreasury::Internal::Type::BaseModel
          ...
          # @!attribute currency
          #
          #   @return [Symbol, ModernTreasury::Models::BulkRequestCreateParams::Resource::ExpectedPaymentUpdateRequestWithID::Currency, nil]
          optional :currency,
                   enum: -> {
          ...
          #   @param counterparty_id [String, nil] The ID of the counterparty you expect for this payment.
          #
          #   @param currency [Symbol, ModernTreasury::Models::BulkRequestCreateParams::Resource::ExpectedPaymentUpdateRequestWithID::Currency, nil]
          #
          #   @param date_lower_bound [Date, nil] The earliest date the payment may come in. Format: yyyy-mm-dd
          #
          #   @param date_upper_bound [Date, nil] The latest date the payment may come in. Format: yyyy-mm-dd
          ...
          # @see ModernTreasury::Models::BulkRequestCreateParams::Resource::ExpectedPaymentUpdateRequestWithID#currency
          module Currency
            extend ModernTreasury::Internal::Type::Enum
