    ...
    class BulkRequestCreateParams < ModernTreasury::BaseModel
      ...
      class Resource < ModernTreasury::Union
        ...
        class PaymentOrderAsyncCreateRequest < ModernTreasury::BaseModel
          ...
          #
          #   @return [Symbol, ModernTreasury::Models::BulkRequestCreateParams::Resource::PaymentOrderAsyncCreateRequest::ChargeBearer]
          ...
          #
          #   @return [Symbol, ModernTreasury::Models::BulkRequestCreateParams::Resource::PaymentOrderAsyncCreateRequest::ForeignExchangeIndicator]
          ...
          #   #
          #   # @param accounting [ModernTreasury::Models::BulkRequestCreateParams::Resource::PaymentOrderAsyncCreateRequest::Accounting, nil]
          #   #
          ...
          #   #
          #   # @param ledger_transaction [ModernTreasury::Models::BulkRequestCreateParams::Resource::PaymentOrderAsyncCreateRequest::LedgerTransaction, nil] Specifies a ledger transaction object that will be created with the payment
          ...
          #   #
          #   # @param line_items [Array<ModernTreasury::Models::BulkRequestCreateParams::Resource::PaymentOrderAsyncCreateRequest::LineItem>, nil] An array of line items that must sum up to the amount of the payment order.
          #   #
          #   # @param metadata [Hash{Symbol => String}, nil] Additional data represented as key-value pairs. Both the key and value must be
          #   #   strings.
          #   #
          ...
          #   #
          #   # @param receiving_account [ModernTreasury::Models::BulkRequestCreateParams::Resource::PaymentOrderAsyncCreateRequest::ReceivingAccount, nil] Either `receiving_account` or `receiving_account_id` must be present. When using
          ...
          class ReceivingAccount < ModernTreasury::BaseModel
            ...
            #
            #   @return [Symbol, ModernTreasury::Models::BulkRequestCreateParams::Resource::PaymentOrderAsyncCreateRequest::ReceivingAccount::PartyType]
            optional :party_type,
                     enum: -> {
            ...
            #   #   internal account.
            #   #
            #   # @param account_details [Array<ModernTreasury::Models::BulkRequestCreateParams::Resource::PaymentOrderAsyncCreateRequest::ReceivingAccount::AccountDetail>, nil]
            #   #
            #   # @param account_type [String, nil] Can be `checking`, `savings` or `other`.
            #   #
            #   # @param contact_details [Array<ModernTreasury::Models::BulkRequestCreateParams::Resource::PaymentOrderAsyncCreateRequest::ReceivingAccount::ContactDetail>, nil]
            #   #
            #   # @param ledger_account [ModernTreasury::Models::BulkRequestCreateParams::Resource::PaymentOrderAsyncCreateRequest::ReceivingAccount::LedgerAccount, nil] Specifies a ledger account object that will be created with the external
            ...
            #   #   affect any payments
            #   #
            #   # @param party_address [ModernTreasury::Models::BulkRequestCreateParams::Resource::PaymentOrderAsyncCreateRequest::ReceivingAccount::PartyAddress, nil] Required if receiving wire payments.
            #   #
            ...
            #   #
            #   # @param routing_details [Array<ModernTreasury::Models::BulkRequestCreateParams::Resource::PaymentOrderAsyncCreateRequest::ReceivingAccount::RoutingDetail>, nil]
            #   #
            #   def initialize(
            #     account_details: nil,
            #     account_type: nil,
        ...
        class ExpectedPaymentCreateRequest < ModernTreasury::BaseModel
          ...
          #
          #   @return [Symbol, ModernTreasury::Models::BulkRequestCreateParams::Resource::ExpectedPaymentCreateRequest::Direction]
          optional :direction,
                   enum: -> {
          ...
          #   #
          #   # @param ledger_transaction [ModernTreasury::Models::BulkRequestCreateParams::Resource::ExpectedPaymentCreateRequest::LedgerTransaction, nil] Specifies a ledger transaction object that will be created with the expected
          ...
          #   #
          #   # @param line_items [Array<ModernTreasury::Models::BulkRequestCreateParams::Resource::ExpectedPaymentCreateRequest::LineItem>, nil]
          #   #
          #   # @param metadata [Hash{Symbol => String}, nil] Additional data represented as key-value pairs. Both the key and value must be
          #   #   strings.
          #   #
        ...
        class TransactionCreateRequest < ModernTreasury::BaseModel
          ...
          #
          #   @return [Symbol, ModernTreasury::Models::BulkRequestCreateParams::Resource::TransactionCreateRequest::Type]
          optional :type,
                   enum: -> {
        ...
        class PaymentOrderUpdateRequestWithID < ModernTreasury::BaseModel
          ...
          #   The party that will pay the fees for the payment order. Only applies to wire payment orders. Can be one of shared, sender, or receiver, which correspond respectively with the SWIFT 71A values `SHA`, `OUR`, `BEN`.
          #
          #   @return [Symbol, ModernTreasury::Models::BulkRequestCreateParams::Resource::PaymentOrderUpdateRequestWithID::ChargeBearer]
          optional :charge_bearer,
                   enum: -> {
          ...
          #   Indicates the type of FX transfer to initiate, can be either `variable_to_fixed`, `fixed_to_variable`, or `null` if the payment order currency matches the originating account currency.
          #
          #   @return [Symbol, ModernTreasury::Models::BulkRequestCreateParams::Resource::PaymentOrderUpdateRequestWithID::ForeignExchangeIndicator]
          optional :foreign_exchange_indicator,
                   enum: -> {
          ...
          #   # @param id [String, nil]
          #   #
          #   # @param accounting [ModernTreasury::Models::BulkRequestCreateParams::Resource::PaymentOrderUpdateRequestWithID::Accounting, nil]
          #   #
          #   # @param accounting_category_id [String, nil] The ID of one of your accounting categories. Note that these will only be
          #   #   accessible if your accounting system has been connected.
          #   #
          ...
          #   #   accessible if your accounting system has been connected.
          #   #
          #   # @param amount [Integer, nil] Value in specified currency's smallest unit. e.g. $10 would be represented as
          #   #   1000 (cents). For RTP, the maximum amount allowed by the network is $100,000.
          #   #
          #   # @param charge_bearer [String, nil] The party that will pay the fees for the payment order. Only applies to wire
          #   #   payment orders. Can be one of shared, sender, or receiver, which correspond
          ...
          #   # @param description [String, nil] An optional description for internal use.
          #   #
          #   # @param direction [String, nil] One of `credit`, `debit`. Describes the direction money is flowing in the
          #   #   transaction. A `credit` moves money from your account to someone else's. A
          #   #   `debit` pulls money from someone else's account to your own. Note that wire,
          #   #   rtp, and check payments will always be `credit`.
          #   #
          ...
          #   #   currency matches the originating account currency.
          #   #
          #   # @param line_items [Array<ModernTreasury::Models::BulkRequestCreateParams::Resource::PaymentOrderUpdateRequestWithID::LineItem>, nil] An array of line items that must sum up to the amount of the payment order.
          #   #
          #   # @param metadata [Hash{Symbol => String}, nil] Additional data represented as key-value pairs. Both the key and value must be
          #   #   strings.
          #   #
          ...
          #   #   digit CPA Code that will be attached to the payment.
          #   #
          #   # @param receiving_account [ModernTreasury::Models::BulkRequestCreateParams::Resource::PaymentOrderUpdateRequestWithID::ReceivingAccount, nil] Either `receiving_account` or `receiving_account_id` must be present. When using
          #   #   `receiving_account_id`, you may pass the id of an external account or an
          #   #   internal account.
          #   #
          #   # @param receiving_account_id [String, nil] Either `receiving_account` or `receiving_account_id` must be present. When using
          ...
          #   #   characters.
          #   #
          #   # @param status [String, nil] To cancel a payment order, use `cancelled`. To redraft a returned payment order,
          ...
          #   #   `CCD`, `PPD`, `IAT`, `CTX`, `WEB`, `CIE`, and `TEL`.
          #   #
          #   # @param type [String, nil] One of `ach`, `se_bankgirot`, `eft`, `wire`, `check`, `sen`, `book`, `rtp`,
          #   #   `sepa`, `bacs`, `au_becs`, `interac`, `neft`, `nics`,
          #   #   `nz_national_clearing_code`, `sic`, `signet`, `provexchange`, `zengin`.
          #   #
          ...
          class ReceivingAccount < ModernTreasury::BaseModel
            ...
            #   Either `individual` or `business`.
            #
            #   @return [Symbol, ModernTreasury::Models::BulkRequestCreateParams::Resource::PaymentOrderUpdateRequestWithID::ReceivingAccount::PartyType]
            optional :party_type,
                     enum: -> {
            ...
            #   #   internal account.
            #   #
            #   # @param account_details [Array<ModernTreasury::Models::BulkRequestCreateParams::Resource::PaymentOrderUpdateRequestWithID::ReceivingAccount::AccountDetail>, nil]
            #   #
            #   # @param account_type [String, nil] Can be `checking`, `savings` or `other`.
            #   #
            #   # @param contact_details [Array<ModernTreasury::Models::BulkRequestCreateParams::Resource::PaymentOrderUpdateRequestWithID::ReceivingAccount::ContactDetail>, nil]
            #   #
            #   # @param ledger_account [ModernTreasury::Models::BulkRequestCreateParams::Resource::PaymentOrderUpdateRequestWithID::ReceivingAccount::LedgerAccount, nil] Specifies a ledger account object that will be created with the external
            #   #   account. The resulting ledger account is linked to the external account for
            #   #   auto-ledgering Payment objects. See
            #   #   https://docs.moderntreasury.com/docs/linking-to-other-modern-treasury-objects
            #   #   for more details.
            ...
            #   #   affect any payments
            #   #
            #   # @param party_address [ModernTreasury::Models::BulkRequestCreateParams::Resource::PaymentOrderUpdateRequestWithID::ReceivingAccount::PartyAddress, nil] Required if receiving wire payments.
            #   #
            #   # @param party_identifier [String, nil]
            #   #
            #   # @param party_name [String, nil] If this value isn't provided, it will be inherited from the counterparty's name.
            ...
            #   #   you can pass the processor token in this field.
            #   #
            #   # @param routing_details [Array<ModernTreasury::Models::BulkRequestCreateParams::Resource::PaymentOrderUpdateRequestWithID::ReceivingAccount::RoutingDetail>, nil]
            #   #
            #   def initialize(
            #     account_details: nil,
            #     account_type: nil,
        ...
        class ExpectedPaymentUpdateRequestWithID < ModernTreasury::BaseModel
          ...
          #   One of credit or debit. When you are receiving money, use credit. When you are being charged, use debit.
          #
          #   @return [Symbol, ModernTreasury::Models::BulkRequestCreateParams::Resource::ExpectedPaymentUpdateRequestWithID::Direction]
          optional :direction,
                   enum: -> {
          ...
          #
          #   @return [Symbol, ModernTreasury::Models::BulkRequestCreateParams::Resource::ExpectedPaymentUpdateRequestWithID::Status]
          optional :status,
                   enum: -> {
        ...
        class LedgerTransactionUpdateRequestWithID < ModernTreasury::BaseModel
          ...
          #   #   reporting purposes.
          #   #
          #   # @param ledger_entries [Array<ModernTreasury::Models::BulkRequestCreateParams::Resource::LedgerTransactionUpdateRequestWithID::LedgerEntry>, nil] An array of ledger entry objects.
          #   #
          #   # @param ledgerable_id [String, nil] If the ledger transaction can be reconciled to another object in Modern
          #   #   Treasury, the id will be populated here, otherwise null.
          #   #
