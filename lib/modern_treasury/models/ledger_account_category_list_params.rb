...
module ModernTreasury
  module Models
    class LedgerAccountCategoryListParams < ModernTreasury::BaseModel
      ...
      #   #
      #   # @param balances [ModernTreasury::Models::LedgerAccountCategoryListParams::Balances, nil] For example, if you want the balances as of a particular time (ISO8601), the
