...
module ModernTreasury
  module Models
    class LegalEntityCreate < ModernTreasury::Internal::Type::BaseModel
      ...
      #
      #   @return [Symbol, ModernTreasury::Models::LegalEntityCreate::LegalEntityType]
      required :legal_entity_type, enum: -> { ModernTreasury::LegalEntityCreate::LegalEntityType }
      ...
      #
      #   @return [Symbol, ModernTreasury::Models::LegalEntityCreate::LegalStructure, nil]
      optional :legal_structure, enum: -> { ModernTreasury::LegalEntityCreate::LegalStructure }, nil?: true
      ...
      #
      #   @return [Array<ModernTreasury::Models::LegalEntityCreate::PhoneNumber>, nil]
      optional :phone_numbers,
               -> { ModernTreasury::Internal::Type::ArrayOf[ModernTreasury::LegalEntityCreate::PhoneNumber] }
      ...
      #
      #   @return [Symbol, ModernTreasury::Models::LegalEntityCreate::RiskRating, nil]
      optional :risk_rating, enum: -> { ModernTreasury::LegalEntityCreate::RiskRating }, nil?: true
      ...
      #   {ModernTreasury::Models::LegalEntityCreate} for more details.
      #
      ...
      # The type of legal entity.
      #
      # @see ModernTreasury::Models::LegalEntityCreate#legal_entity_type
      ...
      # The business's legal structure.
      #
      # @see ModernTreasury::Models::LegalEntityCreate#legal_structure
      ...
      # The risk rating of the legal entity. One of low, medium, high.
      #
      # @see ModernTreasury::Models::LegalEntityCreate#risk_rating
      module RiskRating
        extend ModernTreasury::Internal::Type::Enum
