...
module ModernTreasury
  module Models
    class BulkResult < BaseModel
      ...
      #
      # @overload initialize(id: nil, created_at: nil, entity: nil, entity_id: nil, entity_type: nil, live_mode: nil, object: nil, request_id: nil, request_params: nil, request_type: nil, status: nil, updated_at: nil)
      # @param id [String]
      # @param created_at [String]
      # @param entity [Object] An object with type as indicated by `entity_type`. This is the result object
