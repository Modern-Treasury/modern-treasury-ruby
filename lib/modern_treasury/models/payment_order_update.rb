...
module ModernTreasury
  module Models
    class PaymentOrderUpdate < ModernTreasury::Internal::Type::BaseModel
      ...
      #
      #   @return [Symbol, ModernTreasury::Models::PaymentOrderUpdate::ChargeBearer, nil]
      optional :charge_bearer, enum: -> { ModernTreasury::PaymentOrderUpdate::ChargeBearer }, nil?: true
      ...
      #
      #   @return [Symbol, ModernTreasury::Models::PaymentOrderUpdate::Direction, nil]
      optional :direction, enum: -> { ModernTreasury::PaymentOrderUpdate::Direction }
      ...
      #
      #   @return [Symbol, ModernTreasury::Models::PaymentOrderUpdate::FallbackType, nil]
      optional :fallback_type, enum: -> { ModernTreasury::PaymentOrderUpdate::FallbackType }
      ...
      #
      #   @return [Symbol, ModernTreasury::Models::PaymentOrderUpdate::ForeignExchangeIndicator, nil]
      optional :foreign_exchange_indicator,
               enum: -> { ModernTreasury::PaymentOrderUpdate::ForeignExchangeIndicator },
               nil?: true
      ...
      #
      #   @return [Symbol, ModernTreasury::Models::PaymentOrderUpdate::Priority, nil]
      optional :priority, enum: -> { ModernTreasury::PaymentOrderUpdate::Priority }
      ...
      #   internal account.
      #
      #   @return [ModernTreasury::Models::PaymentOrderUpdate::ReceivingAccount, nil]
      optional :receiving_account, -> { ModernTreasury::PaymentOrderUpdate::ReceivingAccount }
      ...
      #
      #   @return [Symbol, ModernTreasury::Models::PaymentOrderUpdate::ReconciliationStatus, nil]
      optional :reconciliation_status, enum: -> { ModernTreasury::PaymentOrderUpdate::ReconciliationStatus }
      ...
      #   `needs_approval`.
      #
      #   @return [Symbol, ModernTreasury::Models::PaymentOrderUpdate::Status, nil]
      optional :status, enum: -> { ModernTreasury::PaymentOrderUpdate::Status }
      ...
      #   {ModernTreasury::Models::PaymentOrderUpdate} for more details.
      #
      ...
      # differences between the options.
      #
      # @see ModernTreasury::Models::PaymentOrderUpdate#charge_bearer
      module ChargeBearer
      ...
      # rtp, and check payments will always be `credit`.
      #
      # @see ModernTreasury::Models::PaymentOrderUpdate#direction
      module Direction
        extend ModernTreasury::Internal::Type::Enum
      ...
      # (type=rtp and fallback_type=ach)
      #
      # @see ModernTreasury::Models::PaymentOrderUpdate#fallback_type
      module FallbackType
        extend ModernTreasury::Internal::Type::Enum
      ...
      # currency matches the originating account currency.
      #
      # @see ModernTreasury::Models::PaymentOrderUpdate#foreign_exchange_indicator
      ...
      # an overnight check rather than standard mail.
      #
      # @see ModernTreasury::Models::PaymentOrderUpdate#priority
      module Priority
        extend ModernTreasury::Internal::Type::Enum
      ...
      # @see ModernTreasury::Models::PaymentOrderUpdate#receiving_account
      class ReceivingAccount < ModernTreasury::Internal::Type::BaseModel
        # @!attribute account_details
        #
        #   @return [Array<ModernTreasury::Models::PaymentOrderUpdate::ReceivingAccount::AccountDetail>, nil]
        optional :account_details,
                 -> { ModernTreasury::Internal::Type::ArrayOf[ModernTreasury::PaymentOrderUpdate::ReceivingAccount::AccountDetail] }
        ...
        #
        #   @return [Symbol, ModernTreasury::Models::PaymentOrderUpdate::ReceivingAccount::PartyType, nil]
        optional :party_type,
                 enum: -> { ModernTreasury::PaymentOrderUpdate::ReceivingAccount::PartyType },
                 nil?: true
        ...
        #
        #   @return [Array<ModernTreasury::Models::PaymentOrderUpdate::ReceivingAccount::RoutingDetail>, nil]
        optional :routing_details,
                 -> { ModernTreasury::Internal::Type::ArrayOf[ModernTreasury::PaymentOrderUpdate::ReceivingAccount::RoutingDetail] }
        ...
        #   Some parameter documentations has been truncated, see
        #   {ModernTreasury::Models::PaymentOrderUpdate::ReceivingAccount} for more details.
        #
        #   Either `receiving_account` or `receiving_account_id` must be present. When using
        #   `receiving_account_id`, you may pass the id of an external account or an
        #   internal account.
        #
        #   @param account_details [Array<ModernTreasury::Models::PaymentOrderUpdate::ReceivingAccount::AccountDetail>]
        #
        ...
        #
        #   @param party_type [Symbol, ModernTreasury::Models::PaymentOrderUpdate::ReceivingAccount::PartyType, nil] Either `individual` or `business`.
        #
        #   @param plaid_processor_token [String] If you've enabled the Modern Treasury + Plaid integration in your Plaid account,
        #
        #   @param routing_details [Array<ModernTreasury::Models::PaymentOrderUpdate::ReceivingAccount::RoutingDetail>]
        ...
        class AccountDetail < ModernTreasury::Internal::Type::BaseModel
          ...
          #
          #   @return [Symbol, ModernTreasury::Models::PaymentOrderUpdate::ReceivingAccount::AccountDetail::AccountNumberType, nil]
          optional :account_number_type,
                   enum: -> { ModernTreasury::PaymentOrderUpdate::ReceivingAccount::AccountDetail::AccountNumberType }

          # @!method initialize(account_number:, account_number_type: nil)
          #   @param account_number [String]
          #   @param account_number_type [Symbol, ModernTreasury::Models::PaymentOrderUpdate::ReceivingAccount::AccountDetail::AccountNumberType]

          # @see ModernTreasury::Models::PaymentOrderUpdate::ReceivingAccount::AccountDetail#account_number_type
        ...
        # Either `individual` or `business`.
        #
        # @see ModernTreasury::Models::PaymentOrderUpdate::ReceivingAccount#party_type
        module PartyType
          extend ModernTreasury::Internal::Type::Enum
        ...
        class RoutingDetail < ModernTreasury::Internal::Type::BaseModel
          ...
          #
          #   @return [Symbol, ModernTreasury::Models::PaymentOrderUpdate::ReceivingAccount::RoutingDetail::RoutingNumberType]
          required :routing_number_type,
                   enum: -> { ModernTreasury::PaymentOrderUpdate::ReceivingAccount::RoutingDetail::RoutingNumberType }

          # @!attribute payment_type
          #
          #   @return [Symbol, ModernTreasury::Models::PaymentOrderUpdate::ReceivingAccount::RoutingDetail::PaymentType, nil]
          optional :payment_type,
                   enum: -> { ModernTreasury::PaymentOrderUpdate::ReceivingAccount::RoutingDetail::PaymentType }

          # @!method initialize(routing_number:, routing_number_type:, payment_type: nil)
          #   @param routing_number [String]
          #   @param routing_number_type [Symbol, ModernTreasury::Models::PaymentOrderUpdate::ReceivingAccount::RoutingDetail::RoutingNumberType]
          #   @param payment_type [Symbol, ModernTreasury::Models::PaymentOrderUpdate::ReceivingAccount::RoutingDetail::PaymentType]

          # @see ModernTreasury::Models::PaymentOrderUpdate::ReceivingAccount::RoutingDetail#routing_number_type
          ...
          # @see ModernTreasury::Models::PaymentOrderUpdate::ReceivingAccount::RoutingDetail#payment_type
          module PaymentType
            extend ModernTreasury::Internal::Type::Enum
      ...
      # One of `unreconciled`, `tentatively_reconciled` or `reconciled`.
      #
      # @see ModernTreasury::Models::PaymentOrderUpdate#reconciliation_status
      ...
      # `needs_approval`.
      #
      # @see ModernTreasury::Models::PaymentOrderUpdate#status
      module Status
        extend ModernTreasury::Internal::Type::Enum
