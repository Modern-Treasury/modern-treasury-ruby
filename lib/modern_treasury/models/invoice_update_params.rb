...
module ModernTreasury
  module Models
    ...
    class InvoiceUpdateParams < ModernTreasury::Internal::Type::BaseModel
      ...
      #   contact support.
      #
      #   @return [Array<ModernTreasury::Models::Invoices::InvoiceLineItemCreate>, nil]
      optional :invoice_line_items,
               -> {
                 ModernTreasury::Internal::Type::ArrayOf[ModernTreasury::Invoices::InvoiceLineItemCreate]
               },
               nil?: true
