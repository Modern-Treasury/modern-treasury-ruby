...
module ModernTreasury
  module Models
    class InvoiceUpdateParams < ModernTreasury::BaseModel
      ...
      #   #
      #   # @param invoice_line_items [Array<ModernTreasury::Models::InvoiceUpdateParams::InvoiceLineItem>] An array of invoice line items. The API supports a maximum of 50 invoice line
      ...
      #   #
      #   # @param payment_method [String] The method by which the invoice can be paid. `ui` will show the embedded payment
      ...
      #   #
      #   # @param payment_type [String] One of `ach`, `se_bankgirot`, `eft`, `wire`, `check`, `sen`, `book`, `rtp`,
      ...
      #   #   invoice recipients.
      #   #
      #   # @param status [String] Invoice status must be updated in a `PATCH` request that does not modify any
      ...
      #   contact_identifier_type: enum: ModernTreasury::Models::InvoiceUpdateParams::ContactDetail::ContactIdentifierType,
      #   created_at: Time,
      #   discarded_at: Time,
      #   **_
      # }
