...
module ModernTreasury
  module Models
    ...
    class LineItemUpdateResponse < ModernTreasury::Internal::Type::BaseModel
      # @!attribute id
      #
      #   @return [String]
      required :id, String
      ...
      #
      #   @return [Symbol, ModernTreasury::Models::LineItemUpdateResponse::ItemizableType]
      required :itemizable_type, enum: -> { ModernTreasury::Models::LineItemUpdateResponse::ItemizableType }
      ...
      #   {ModernTreasury::Models::LineItemUpdateResponse} for more details.
      #
      #   @param id [String]
      #
      ...
      #
      #   @param itemizable_type [Symbol, ModernTreasury::Models::LineItemUpdateResponse::ItemizableType] One of `payment_orders` or `expected_payments`.
      #
      ...
      # One of `payment_orders` or `expected_payments`.
      #
      # @see ModernTreasury::Models::LineItemUpdateResponse#itemizable_type
