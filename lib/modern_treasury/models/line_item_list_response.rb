...
module ModernTreasury
  module Models
    ...
    class LineItemListResponse < ModernTreasury::Internal::Type::BaseModel
      ...
      #
      #   @return [Symbol, ModernTreasury::Models::LineItemListResponse::ItemizableType]
      required :itemizable_type, enum: -> { ModernTreasury::Models::LineItemListResponse::ItemizableType }
      ...
      #   {ModernTreasury::Models::LineItemListResponse} for more details.
      #
      #   @param id [String]
      #
      ...
      #
      #   @param itemizable_type [Symbol, ModernTreasury::Models::LineItemListResponse::ItemizableType] One of `payment_orders` or `expected_payments`.
      #
      ...
      # One of `payment_orders` or `expected_payments`.
      #
      # @see ModernTreasury::Models::LineItemListResponse#itemizable_type
