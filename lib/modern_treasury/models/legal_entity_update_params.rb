...
module ModernTreasury
  module Models
    ...
    class LegalEntityUpdateParams < ModernTreasury::Internal::Type::BaseModel
      ...
      #
      #   @return [ModernTreasury::Models::LegalEntityUpdateParams::BankSettings, nil]
      optional :bank_settings, -> { ModernTreasury::LegalEntityUpdateParams::BankSettings }, nil?: true
      ...
      #
      #   @return [ModernTreasury::Models::LegalEntityUpdateParams::WealthAndEmploymentDetails, nil]
      ...
      #
      #   @param bank_settings [ModernTreasury::Models::LegalEntityUpdateParams::BankSettings, nil]
      #
      ...
      #
      #   @param wealth_and_employment_details [ModernTreasury::Models::LegalEntityUpdateParams::WealthAndEmploymentDetails, nil]
      #
