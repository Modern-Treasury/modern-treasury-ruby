...
module ModernTreasury
  module Models
    ...
    #
    # ```ruby
    # ledger_account_statement_create_response => {
    #   id: String,
    #   created_at: Time,
    #   description: String,
    ...
    class LedgerAccountStatementCreateResponse < ModernTreasury::BaseModel
      ...
      #   #   be included in the ledger account statement.
      #   #
      #   # @param ending_balance [ModernTreasury::Models::LedgerAccountStatementCreateResponse::EndingBalance] The pending, posted, and available balances for this ledger account at the
      ...
      #   # @param object [String]
      #   #
      #   # @param starting_balance [ModernTreasury::Models::LedgerAccountStatementCreateResponse::StartingBalance] The pending, posted, and available balances for this ledger account at the
      ...
      class EndingBalance < ModernTreasury::BaseModel
        ...
        #   #   sum of the pending and posted outgoing amounts.
        #   #
        #   # @param available_balance [ModernTreasury::Models::LedgerAccountStatementCreateResponse::EndingBalance::AvailableBalance] The available_balance is the sum of all posted inbound entries and pending
      ...
      class StartingBalance < ModernTreasury::BaseModel
        ...
        #   #   sum of the pending and posted outgoing amounts.
        #   #
        #   # @param available_balance [ModernTreasury::Models::LedgerAccountStatementCreateResponse::StartingBalance::AvailableBalance] The available_balance is the sum of all posted inbound entries and pending
        #   #   outbound entries. For credit normal, available_amount = posted_credits -
        #   #   pending_debits; for debit normal, available_amount = posted_debits -
        #   #   pending_credits.
        #   #
