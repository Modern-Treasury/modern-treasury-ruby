...
module ModernTreasury
  module Models
    ...
    class ExpectedPaymentCreateParams < ModernTreasury::Internal::Type::BaseModel
      ...
      # @!attribute currency
      #
      #   @return [Symbol, ModernTreasury::Models::ExpectedPaymentCreateParams::Currency, nil]
      optional :currency, enum: -> { ModernTreasury::ExpectedPaymentCreateParams::Currency }, nil?: true
      ...
      #
      #   @param currency [Symbol, ModernTreasury::Models::ExpectedPaymentCreateParams::Currency, nil]
      #
