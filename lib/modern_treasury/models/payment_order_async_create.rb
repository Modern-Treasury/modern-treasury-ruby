...
module ModernTreasury
  module Models
    class PaymentOrderAsyncCreate < ModernTreasury::Internal::Type::BaseModel
      # @!attribute amount
      ...
      #
      #   @return [Symbol, ModernTreasury::Models::PaymentOrderAsyncCreate::Direction]
      required :direction, enum: -> { ModernTreasury::PaymentOrderAsyncCreate::Direction }
      ...
      #
      #   @return [Symbol, ModernTreasury::Models::PaymentOrderAsyncCreate::ChargeBearer, nil]
      optional :charge_bearer, enum: -> { ModernTreasury::PaymentOrderAsyncCreate::ChargeBearer }, nil?: true
      ...
      #
      #   @return [Symbol, ModernTreasury::Models::PaymentOrderAsyncCreate::FallbackType, nil]
      optional :fallback_type, enum: -> { ModernTreasury::PaymentOrderAsyncCreate::FallbackType }
      ...
      #
      #   @return [Symbol, ModernTreasury::Models::PaymentOrderAsyncCreate::ForeignExchangeIndicator, nil]
      optional :foreign_exchange_indicator,
               enum: -> { ModernTreasury::PaymentOrderAsyncCreate::ForeignExchangeIndicator },
               nil?: true
      ...
      #
      #   @return [Symbol, ModernTreasury::Models::PaymentOrderAsyncCreate::Priority, nil]
      optional :priority, enum: -> { ModernTreasury::PaymentOrderAsyncCreate::Priority }
      ...
      #   internal account.
      #
      #   @return [ModernTreasury::Models::PaymentOrderAsyncCreate::ReceivingAccount, nil]
      optional :receiving_account, -> { ModernTreasury::PaymentOrderAsyncCreate::ReceivingAccount }
      ...
      #
      #   @return [Symbol, ModernTreasury::Models::PaymentOrderAsyncCreate::ReconciliationStatus, nil]
      optional :reconciliation_status,
               enum: -> { ModernTreasury::PaymentOrderAsyncCreate::ReconciliationStatus }
      ...
      #   {ModernTreasury::Models::PaymentOrderAsyncCreate} for more details.
      #
      ...
      # rtp, and check payments will always be `credit`.
      #
      # @see ModernTreasury::Models::PaymentOrderAsyncCreate#direction
      module Direction
      ...
      # differences between the options.
      #
      # @see ModernTreasury::Models::PaymentOrderAsyncCreate#charge_bearer
      module ChargeBearer
        extend ModernTreasury::Internal::Type::Enum
      ...
      # (type=rtp and fallback_type=ach)
      #
      # @see ModernTreasury::Models::PaymentOrderAsyncCreate#fallback_type
      module FallbackType
        extend ModernTreasury::Internal::Type::Enum
      ...
      # currency matches the originating account currency.
      #
      # @see ModernTreasury::Models::PaymentOrderAsyncCreate#foreign_exchange_indicator
      ...
      # an overnight check rather than standard mail.
      #
      # @see ModernTreasury::Models::PaymentOrderAsyncCreate#priority
      module Priority
        extend ModernTreasury::Internal::Type::Enum
      ...
      # @see ModernTreasury::Models::PaymentOrderAsyncCreate#receiving_account
      class ReceivingAccount < ModernTreasury::Internal::Type::BaseModel
        # @!attribute account_details
        #
        #   @return [Array<ModernTreasury::Models::PaymentOrderAsyncCreate::ReceivingAccount::AccountDetail>, nil]
        optional :account_details,
                 -> { ModernTreasury::Internal::Type::ArrayOf[ModernTreasury::PaymentOrderAsyncCreate::ReceivingAccount::AccountDetail] }
        ...
        #
        #   @return [Symbol, ModernTreasury::Models::PaymentOrderAsyncCreate::ReceivingAccount::PartyType, nil]
        optional :party_type,
                 enum: -> { ModernTreasury::PaymentOrderAsyncCreate::ReceivingAccount::PartyType },
                 nil?: true
        ...
        #
        #   @return [Array<ModernTreasury::Models::PaymentOrderAsyncCreate::ReceivingAccount::RoutingDetail>, nil]
        optional :routing_details,
                 -> { ModernTreasury::Internal::Type::ArrayOf[ModernTreasury::PaymentOrderAsyncCreate::ReceivingAccount::RoutingDetail] }
        ...
        #   Some parameter documentations has been truncated, see
        #   {ModernTreasury::Models::PaymentOrderAsyncCreate::ReceivingAccount} for more
        #   details.
        #
        #   Either `receiving_account` or `receiving_account_id` must be present. When using
        #   `receiving_account_id`, you may pass the id of an external account or an
        #   internal account.
        #
        #   @param account_details [Array<ModernTreasury::Models::PaymentOrderAsyncCreate::ReceivingAccount::AccountDetail>]
        #
        ...
        #
        #   @param party_type [Symbol, ModernTreasury::Models::PaymentOrderAsyncCreate::ReceivingAccount::PartyType, nil] Either `individual` or `business`.
        #
        #   @param plaid_processor_token [String] If you've enabled the Modern Treasury + Plaid integration in your Plaid account,
        #
        #   @param routing_details [Array<ModernTreasury::Models::PaymentOrderAsyncCreate::ReceivingAccount::RoutingDetail>]
        ...
        class AccountDetail < ModernTreasury::Internal::Type::BaseModel
          ...
          #
          #   @return [Symbol, ModernTreasury::Models::PaymentOrderAsyncCreate::ReceivingAccount::AccountDetail::AccountNumberType, nil]
          optional :account_number_type,
                   enum: -> { ModernTreasury::PaymentOrderAsyncCreate::ReceivingAccount::AccountDetail::AccountNumberType }

          # @!method initialize(account_number:, account_number_type: nil)
          #   @param account_number [String]
          #   @param account_number_type [Symbol, ModernTreasury::Models::PaymentOrderAsyncCreate::ReceivingAccount::AccountDetail::AccountNumberType]

          # @see ModernTreasury::Models::PaymentOrderAsyncCreate::ReceivingAccount::AccountDetail#account_number_type
        ...
        # Either `individual` or `business`.
        #
        # @see ModernTreasury::Models::PaymentOrderAsyncCreate::ReceivingAccount#party_type
        module PartyType
          extend ModernTreasury::Internal::Type::Enum
        ...
        class RoutingDetail < ModernTreasury::Internal::Type::BaseModel
          ...
          #
          #   @return [Symbol, ModernTreasury::Models::PaymentOrderAsyncCreate::ReceivingAccount::RoutingDetail::RoutingNumberType]
          required :routing_number_type,
                   enum: -> { ModernTreasury::PaymentOrderAsyncCreate::ReceivingAccount::RoutingDetail::RoutingNumberType }

          # @!attribute payment_type
          #
          #   @return [Symbol, ModernTreasury::Models::PaymentOrderAsyncCreate::ReceivingAccount::RoutingDetail::PaymentType, nil]
          optional :payment_type,
                   enum: -> { ModernTreasury::PaymentOrderAsyncCreate::ReceivingAccount::RoutingDetail::PaymentType }

          # @!method initialize(routing_number:, routing_number_type:, payment_type: nil)
          #   @param routing_number [String]
          #   @param routing_number_type [Symbol, ModernTreasury::Models::PaymentOrderAsyncCreate::ReceivingAccount::RoutingDetail::RoutingNumberType]
          #   @param payment_type [Symbol, ModernTreasury::Models::PaymentOrderAsyncCreate::ReceivingAccount::RoutingDetail::PaymentType]

          # @see ModernTreasury::Models::PaymentOrderAsyncCreate::ReceivingAccount::RoutingDetail#routing_number_type
          ...
          # @see ModernTreasury::Models::PaymentOrderAsyncCreate::ReceivingAccount::RoutingDetail#payment_type
          module PaymentType
            extend ModernTreasury::Internal::Type::Enum
      ...
      # One of `unreconciled`, `tentatively_reconciled` or `reconciled`.
      #
      # @see ModernTreasury::Models::PaymentOrderAsyncCreate#reconciliation_status
