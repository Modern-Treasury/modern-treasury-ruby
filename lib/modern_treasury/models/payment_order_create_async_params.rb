...
module ModernTreasury
  module Models
    ...
    class PaymentOrderCreateAsyncParams < ModernTreasury::Internal::Type::BaseModel
      ...
      #
      #   @return [ModernTreasury::Models::PaymentOrderCreateAsyncParams::OriginatingPartyAddress, nil]
      ...
      class OriginatingPartyAddress < ModernTreasury::Internal::Type::BaseModel
        ...
        #   Some parameter documentations has been truncated, see
        #   {ModernTreasury::Models::PaymentOrderCreateAsyncParams::OriginatingPartyAddress}
        #   for more details.
        #
        #   If present, this address will override the default originating party address
        #   used on the payment order. This works across all payment types.
