...
module ModernTreasury
  module Models
    ...
    class PaymentOrder < ModernTreasury::Internal::Type::BaseModel
      ...
      #   data.
      #
      #   @return [ModernTreasury::Models::PaymentOrder::CurrentHold::Hold, Object, nil]
      required :current_hold, union: -> { ModernTreasury::PaymentOrder::CurrentHold }
      ...
      required :current_return, union: -> { ModernTreasury::PaymentOrder::CurrentReturn }
      ...
      required :foreign_exchange_rate, union: -> { ModernTreasury::PaymentOrder::ForeignExchangeRate }
      ...
      #
      #   @param current_hold [ModernTreasury::Models::PaymentOrder::CurrentHold::Hold, Object, nil] If the payment order's status is `held`, this will include the hold object's dat
      #
      #   @param current_return [ModernTreasury::Models::ReturnObject, Object, nil] If the payment order's status is `returned`, this will include the return object
      #
      ...
      module CurrentHold
        ...
        variant -> { ModernTreasury::PaymentOrder::CurrentHold::Hold }
        ...
        class Hold < ModernTreasury::Internal::Type::BaseModel
          ...
          #   The type of object
          #
          #   @return [Symbol, ModernTreasury::Models::PaymentOrder::CurrentHold::Hold::Object]
          required :object, enum: -> { ModernTreasury::PaymentOrder::CurrentHold::Hold::Object }

          # @!attribute status
          #   The status of the hold
          #
          #   @return [Symbol, ModernTreasury::Models::PaymentOrder::CurrentHold::Hold::Status]
          required :status, enum: -> { ModernTreasury::PaymentOrder::CurrentHold::Hold::Status }
          ...
          #
          #   @return [Symbol, ModernTreasury::Models::PaymentOrder::CurrentHold::Hold::TargetType]
          required :target_type, enum: -> { ModernTreasury::PaymentOrder::CurrentHold::Hold::TargetType }
          ...
          #   Some parameter documentations has been truncated, see
          #   {ModernTreasury::Models::PaymentOrder::CurrentHold::Hold} for more details.
          #
          #   @param id [String]
          #
          #   @param created_at [Time]
          #
          #   @param object [Symbol, ModernTreasury::Models::PaymentOrder::CurrentHold::Hold::Object] The type of object
          #
          #   @param status [Symbol, ModernTreasury::Models::PaymentOrder::CurrentHold::Hold::Status] The status of the hold
          #
          #   @param target_id [String] The ID of the target being held
          #
          #   @param target_type [Symbol, ModernTreasury::Models::PaymentOrder::CurrentHold::Hold::TargetType] The type of target being held
          #
          #   @param updated_at [Time]
          #
          #   @param live_mode [Boolean] This field will be true if this object exists in the live environment or false i
          ...
          # The type of object
          #
          # @see ModernTreasury::Models::PaymentOrder::CurrentHold::Hold#object
          module Object
            extend ModernTreasury::Internal::Type::Enum
          ...
          # The status of the hold
          #
          # @see ModernTreasury::Models::PaymentOrder::CurrentHold::Hold#status
          module Status
            extend ModernTreasury::Internal::Type::Enum
          ...
          # The type of target being held
          #
          # @see ModernTreasury::Models::PaymentOrder::CurrentHold::Hold#target_type
          module TargetType
            extend ModernTreasury::Internal::Type::Enum
        ...
        #   @return [Array(ModernTreasury::Models::PaymentOrder::CurrentHold::Hold, Object)]
      end

      # If the payment order's status is `returned`, this will include the return
      # object's data.
      #
      # @see ModernTreasury::Models::PaymentOrder#current_return
