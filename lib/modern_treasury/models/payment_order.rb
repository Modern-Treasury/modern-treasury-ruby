...
module ModernTreasury
  module Models
    ...
    class PaymentOrder < ModernTreasury::Internal::Type::BaseModel
      ...
      #   data.
      #
      #   @return [ModernTreasury::Models::Hold, nil]
      required :current_hold, -> { ModernTreasury::Hold }, nil?: true
      ...
      #
      #   @param current_hold [ModernTreasury::Models::Hold, nil] If the payment order's status is `held`, this will include the hold object's dat
      #
