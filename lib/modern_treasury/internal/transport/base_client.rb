  ...
  module Internal
    module Transport
      ...
      class BaseClient
        ...
        PLATFORM_HEADERS =
          {
            "x-stainless-arch" => ModernTreasury::Internal::Util.arch,
            "x-stainless-lang" => "ruby",
            "x-stainless-os" => ModernTreasury::Internal::Util.os,
        ...
        class << self
          ...
          def should_retry?(status, headers:)
            coerced = ModernTreasury::Internal::Util.coerce_boolean(headers["x-should-retry"])
            case [coerced, status]
            in [true | false, _]
              coerced
          ...
          def follow_redirect(request, status:, response_headers:)
            ...
            # from undici
            if ModernTreasury::Internal::Util.uri_origin(url) != ModernTreasury::Internal::Util.uri_origin(location)
          ...
          # @api private
          #
          # @param status [Integer, ModernTreasury::Errors::APIConnectionError]
          # @param stream [Enumerable<String>, nil]
          def reap_connection!(status, stream:)
            case status
            in (..199) | (300..499)
              stream&.each { next }
            in ModernTreasury::Errors::APIConnectionError | (500..)
        ...
        def initialize(
          ...
          @requester = ModernTreasury::Internal::Transport::PooledNetRequester.new
          @headers = ModernTreasury::Internal::Util.normalized_headers(
          ...
          @base_url = ModernTreasury::Internal::Util.parse_uri(base_url)
        ...
        private def build_request(req, opts)
          ...
          path = ModernTreasury::Internal::Util.interpolate_path(uninterpolated_path)

          query = ModernTreasury::Internal::Util.deep_merge(req[:query].to_h, opts[:extra_query].to_h)
          ...
          headers, encoded = ModernTreasury::Internal::Util.encode_content(headers, body)
          {
            method: method,
            url: ModernTreasury::Internal::Util.join_parsed_uri(@base_url, {**req, path: path, query: query}),
            headers: headers,
            body: encoded,
        ...
        # methods call into.
        #
        # @overload request(method, path, query: {}, headers: {}, body: nil, unwrap: nil, page: nil, stream: nil, model: ModernTreasury::Internal::Type::Unknown, options: {})
        #
        # @param method [Symbol]
        #
        ...
        #
        # @param options [ModernTreasury::RequestOptions, Hash{Symbol=>Object}, nil] .
        #
        ...
        def inspect
          ...
          base_url = ModernTreasury::Internal::Util.unparse_uri(@base_url)
