  ...
  module Internal
    module Type
      ...
      module Union
        ...
        # @api private
        #
        # @param key [Symbol, Hash{Symbol=>Object}, Proc, ModernTreasury::Internal::Type::Converter, Class]
        #
        ...
        # @param value [Object]
        #
        # @return [ModernTreasury::Internal::Type::Converter, Class, nil]
        private def resolve_variant(value)
          ...
          in [Symbol, Hash]
            key = value.fetch(@discriminator) do
              value.fetch(@discriminator.to_s, ModernTreasury::Internal::Util::OMIT)
            end

            return nil if key == ModernTreasury::Internal::Util::OMIT
        ...
        def coerce(value, state:)
          if (target = resolve_variant(value))
            return ModernTreasury::Internal::Type::Converter.coerce(target, value, state: state)
          end
