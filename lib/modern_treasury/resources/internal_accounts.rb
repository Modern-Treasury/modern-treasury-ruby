...
module ModernTreasury
  module Resources
    class InternalAccounts
      ...
      # @option params [Symbol] :currency Either "USD" or "CAD". Internal accounts created at Increase only supports
      #   "USD".
      ...
      # @option params [PartyAddress] :party_address The address associated with the owner or null.
      # @option params [Hash] :vendor_attributes A hash of vendor specific attributes that will be used when creating the account
      ...
      # @option params [Symbol] :currency Only return internal accounts with this currency.
      ...
      #   parameters.
      # @option params [Symbol] :payment_direction Only return internal accounts that can originate payments with this direction.
      # @option params [Symbol] :payment_type Only return internal accounts that can make this type of payment.
