...
module ModernTreasury
  module Resources
    class AccountDetails
      ...
      #
      # @param account_number_type [Symbol, ModernTreasury::Models::AccountDetailCreateParams::AccountNumberType] Body param: One of `iban`, `clabe`, or `other`. Use `other` if the bank account
      #
