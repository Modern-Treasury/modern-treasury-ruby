...
module ModernTreasury
  module Resources
    class PaymentFlows
      ...
      # create payment_flow
      #
      # @param params [Hash{Symbol => Object}, ModernTreasury::Models::PaymentFlowCreateParams] Attributes to send in this request.
      #
      ...
      # @param id [String] id
      #
      # @param params [Hash{Symbol => Object}, ModernTreasury::Models::PaymentFlowUpdateParams] Attributes to send in this request.
      #
      ...
      # list payment_flows
      #
      # @param params [Hash{Symbol => Object}, ModernTreasury::Models::PaymentFlowListParams] Attributes to send in this request.
      #
