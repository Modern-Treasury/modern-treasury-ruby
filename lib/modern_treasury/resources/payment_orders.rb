...
module ModernTreasury
  module Resources
    class PaymentOrders
      ...
      # @option params [Symbol, Direction] :direction One of `credit`, `debit`. Describes the direction money is flowing in the
      ...
      #   accessible if your accounting system has been connected.
      # @option params [Symbol, ChargeBearer, nil] :charge_bearer The party that will pay the fees for the payment order. Only applies to wire
      ...
      # @option params [Array<Document>, nil] :documents An array of documents to be attached to the payment order. Note that if you
      ...
      # @option params [Symbol, ForeignExchangeIndicator, nil] :foreign_exchange_indicator Indicates the type of FX transfer to initiate, can be either
      #   `variable_to_fixed`, `fixed_to_variable`, or `null` if the payment order
      #   currency matches the originating account currency.
      # @option params [LedgerTransaction, nil] :ledger_transaction Specifies a ledger transaction object that will be created with the payment
      ...
      # @option params [Array<LineItem>, nil] :line_items An array of line items that must sum up to the amount of the payment order.
      ...
      # @option params [ReceivingAccount, nil] :receiving_account Either `receiving_account` or `receiving_account_id` must be present. When using
      ...
      # @option params [Symbol, ModernTreasury::Models::Currency, nil] :currency Defaults to the currency of the originating account.
      # @option params [String, nil] :description An optional description for internal use.
      # @option params [Symbol, Direction, nil] :direction One of `credit`, `debit`. Describes the direction money is flowing in the
      #   transaction. A `credit` moves money from your account to someone else's. A
      #   `debit` pulls money from someone else's account to your own. Note that wire,
      #   rtp, and check payments will always be `credit`.
      # @option params [Date, nil] :effective_date Date transactions are to be posted to the participants' account. Defaults to the
      ...
      #   characters for other useful information. For `eft` the maximum length is 15
      #   characters.
      # @option params [Symbol, Status, nil] :status To cancel a payment order, use `cancelled`. To redraft a returned payment order,
