...
module ModernTreasury
  module Resources
    class Invoices
      ...
      #   @option params [Array<InvoiceLineItem>, nil] :invoice_line_items An array of invoice line items. The API supports a maximum of 50 invoice line
      #     items per invoice. If a greater number of invoice line items is required, please
      #     contact support.
      #   @option params [InvoicerAddress, nil] :invoicer_address The invoice issuer's business address.
      ...
      #   @option params [Symbol, PaymentMethod, nil] :payment_method The method by which the invoice can be paid. `ui` will show the embedded payment
