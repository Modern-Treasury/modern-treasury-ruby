    ...
    module Converter
      ...
      class << self
        ...
        def type_info(spec)
          ...
          in ModernTreasury::Type::Converter | Class | Symbol
            -> { spec }
        ...
        #
        # @param target [ModernTreasury::Type::Converter, Class]
        #
        # @param value [Object]
        #
        ...
        def coerce(
          ...
          case target
          in ModernTreasury::Type::Converter
        ...
        def dump(target, value)
          target.is_a?(ModernTreasury::Type::Converter) ? target.dump(value) : ModernTreasury::Unknown.dump(value)
        end
      end
    end
  end
