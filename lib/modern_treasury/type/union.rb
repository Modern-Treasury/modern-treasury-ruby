...
module ModernTreasury
  module Type
    ...
    module Union
      ...
      # @api private
      #
      # @param key [Symbol, Hash{Symbol=>Object}, Proc, ModernTreasury::Type::Converter, Class]
      #
      # @param spec [Hash{Symbol=>Object}, Proc, ModernTreasury::Type::Converter, Class] .
      #
      ...
      private def variant(key, spec = nil)
        variant_info =
          case key
          in Symbol
            [key, ModernTreasury::Type::Converter.type_info(spec)]
          in Proc | ModernTreasury::Type::Converter | Class | Hash
            [nil, ModernTreasury::Type::Converter.type_info(key)]
          end
      ...
      # @param value [Object]
      #
      # @return [ModernTreasury::Type::Converter, Class, nil]
      ...
      def coerce(value, state:)
        if (target = resolve_variant(value))
          return ModernTreasury::Type::Converter.coerce(target, value, state: state)
        end
        ...
        known_variants.each do |_, variant_fn|
          ...
          coerced = ModernTreasury::Type::Converter.coerce(target, value, state: state)
      ...
      def dump(value)
        if (target = resolve_variant(value))
          return ModernTreasury::Type::Converter.dump(target, value)
        end

        known_variants.each do
          target = _2.call
          return ModernTreasury::Type::Converter.dump(target, value) if target === value
        end
