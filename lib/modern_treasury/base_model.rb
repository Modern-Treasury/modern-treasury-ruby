...
module ModernTreasury
  ...
  class Enum
    ...
    # @return [Boolean]
    def self.==(other)
      other.is_a?(Class) && other <= ModernTreasury::Enum && other.values.to_set == values.to_set
    end
  ...
  class Union
    ...
    # @return [Boolean]
    def self.==(other)
      other.is_a?(Class) && other <= ModernTreasury::Union && other.derefed_variants == derefed_variants
    end
  ...
  class BaseModel
    ...
    class << self
      ...
      private def add_field(name_sym, required:, type_info:, spec:)
        type_fn, info =
          case type_info
          in Proc | Class | ModernTreasury::Converter
    ...
    def initialize(data = {})
      ...
      in Hash => coerced
        @data = coerced.to_h do |key, value|
          ...
          stored =
            case [type, value]
            in [Class, Hash] if type <= ModernTreasury::BaseModel
              type.new(value)
