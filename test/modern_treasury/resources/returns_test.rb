  ...
  def test_create_required_params
    ...
    assert_pattern do
      response => {
        ...
        corrections: ModernTreasury::ReturnObject::Corrections | nil,
        created_at: Time,
        currency: ModernTreasury::Currency,
        current_return: ModernTreasury::ReturnObject::CurrentReturn,
        ...
        object: String,
        reason: String | nil,
        reconciliation_status: ModernTreasury::ReturnObject::ReconciliationStatus,
