  ...
  def test_create_required_params
    ...
    assert_pattern do
      response => {
        ...
        current_hold: ModernTreasury::PaymentOrder::CurrentHold | nil,
        ...
        originating_account_type: ModernTreasury::PaymentOrder::OriginatingAccountType,
        originating_party_address: ModernTreasury::PaymentOrder::OriginatingPartyAddress | nil,
        originating_party_name: String | nil,
        originating_secondary_party_name: String | nil,
        ...
        reconciliation_status: ModernTreasury::PaymentOrder::ReconciliationStatus,
