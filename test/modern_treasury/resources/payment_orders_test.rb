  ...
  def test_create_required_params
    ...
    assert_pattern do
      response => {
        ...
        compliance_rule_metadata: ^(ModernTreasury::Internal::Type::HashOf[ModernTreasury::Internal::Type::Unknown]) | nil,
        ...
        nsf_protected: ModernTreasury::Internal::Type::BooleanModel,
        object: String,
        ...
        reference_numbers: ^(ModernTreasury::Internal::Type::ArrayOf[ModernTreasury::Models::PaymentOrder::ReferenceNumber]),
        remittance_information: String | nil,
        send_remittance_advice: ModernTreasury::Internal::Type::BooleanModel | nil,
        ...
        transaction_monitoring_enabled: ModernTreasury::Internal::Type::BooleanModel,
