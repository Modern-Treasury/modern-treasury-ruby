  ...
  def test_retrieve
    ...
    assert_pattern do
      response => {
        ...
        reconciliation_status: ModernTreasury::IncomingPaymentDetail::ReconciliationStatus,
        ...
        virtual_account: ModernTreasury::IncomingPaymentDetail::VirtualAccount,
        virtual_account_id: String | nil,
        originating_account_number: String | nil,
        originating_party_address: ModernTreasury::IncomingPaymentDetail::OriginatingPartyAddress | nil,
        originating_party_name: String | nil,
        originating_party_vendor_identifier: String | nil,
        receiving_account_number: String | nil,
        receiving_account_number_safe: String | nil
      }
    end
  end
