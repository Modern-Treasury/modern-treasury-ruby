...
class ModernTreasury::Test::Resources::LegalEntitiesTest < ModernTreasury::Test::ResourceTest
  def test_create_required_params
    ...
    assert_pattern do
      response => {
        ...
        identifications: ^(ModernTreasury::Internal::Type::ArrayOf[ModernTreasury::Identification]),
  ...
  def test_update_status_required_params
    response = @modern_treasury.legal_entities.update_status("id", status: :active)
