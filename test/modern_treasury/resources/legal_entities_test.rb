  ...
  def test_create_required_params
    ...
    assert_pattern do
      response => {
        ...
        compliance_details: ModernTreasury::Internal::Type::Unknown | nil,
        ...
        regulators: ^(ModernTreasury::Internal::Type::ArrayOf[ModernTreasury::LegalEntity::Regulator]) | nil,
        ...
        suffix: String | nil,
        third_party_verification: ModernTreasury::LegalEntity::ThirdPartyVerification | nil,
        third_party_verifications: ^(ModernTreasury::Internal::Type::ArrayOf[ModernTreasury::LegalEntity::ThirdPartyVerification]),
