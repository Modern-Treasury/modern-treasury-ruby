  ...
  def test_create
    ...
    assert_pattern do
      response => {
        ...
        created_at: Time,
        currency: ModernTreasury::ExpectedPayment::Currency | nil,
        ...
        reconciliation_rule_variables: ^(ModernTreasury::Internal::Type::ArrayOf[ModernTreasury::ReconciliationRule]),
