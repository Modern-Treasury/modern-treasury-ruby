...
class ModernTreasury::Test::SorbetRuntimeSupportTest < Minitest::Test
  ...
  class M < ModernTreasury::Internal::Type::BaseModel
  ...
  def test_nil_aliases
    ...
    assert_raises(err) { ModernTreasury::Internal::Type::BaseModel::KnownField }
    assert_raises(err) { ModernTreasury::Internal::Util::ParsedUri }
    assert_raises(err) { ModernTreasury::Internal::Util::ServerSentEvent }
    assert_raises(err) { ModernTreasury::Internal::Transport::BaseClient::RequestComponents }
    assert_raises(err) { ModernTreasury::Internal::Transport::BaseClient::RequestInput }
    assert_raises(err) { ModernTreasury::Internal::Transport::PooledNetRequester::Request }
