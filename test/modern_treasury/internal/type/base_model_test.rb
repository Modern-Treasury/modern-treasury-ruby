...
class ModernTreasury::Test::PrimitiveModelTest < Minitest::Test
  ...
  def test_typing
    ...
    converters.each do |conv|
      assert_pattern do
        conv => ModernTreasury::Internal::Type::Converter
      end
    end
  end
  ...
  def test_coerce
    cases = {
      ...
      [ModernTreasury::Internal::Type::Boolean, true] => [{yes: 1}, true],
      [ModernTreasury::Internal::Type::Boolean, "true"] => [{no: 1}, "true"],
      [Integer, 1] => [{yes: 1}, 1],
    ...
    cases.each do |lhs, rhs|
      ...
      assert_pattern do
        ModernTreasury::Internal::Type::Converter.coerce(target, input, state: state) => ^expect
  ...
  def test_dump
    cases = {
      ...
      [ModernTreasury::Internal::Type::Boolean, true] => true,
      [ModernTreasury::Internal::Type::Boolean, "true"] => "true",
      [Integer, "1"] => "1",
      [Float, 1] => 1,
      [String, "one"] => "one",
    ...
    cases.each do
      ...
      expect = _2
      assert_pattern do
        ModernTreasury::Internal::Type::Converter.dump(target, input) => ^expect
      end
    end
  end
  ...
  def test_coerce_errors
    ...
    cases.each do |testcase, expect|
      ...
      state = ModernTreasury::Internal::Type::Converter.new_coerce_state
      ModernTreasury::Internal::Type::Converter.coerce(target, input, state: state)
      assert_pattern do
        state => {error: ^expect}
      end
    end
  ...
  def test_dump_retry
    ...
    Pathname(__FILE__).open do |fd|
      ...
      types.product(cases).each do |target, input|
        ...
        ModernTreasury::Internal::Type::Converter.dump(target, input, state: state)
...
class ModernTreasury::Test::UnionTest < Minitest::Test
  class U0
    include ModernTreasury::Internal::Type::Union
...
class ModernTreasury::Test::BaseModelQoLTest < Minitest::Test
  ...
  def test_equality
    cases = {
      ...
      [ModernTreasury::Internal::Type::Boolean, ModernTreasury::Internal::Type::Boolean] => true,
      [ModernTreasury::Internal::Type::Unknown, ModernTreasury::Internal::Type::Boolean] => false,
...
class ModernTreasury::Test::MetaInfoTest < Minitest::Test
  A1 = ModernTreasury::Internal::Type::ArrayOf[Integer, nil?: true, doc: "dog"]
  H1 = ModernTreasury::Internal::Type::HashOf[-> { String }, nil?: true, doc: "dawg"]
