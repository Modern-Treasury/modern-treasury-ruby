...
class ModernTreasury::Test::UtilFusedEnumTest < Minitest::Test
  ...
  def test_close_fused_sse_chain
    ...
    fused_2 = ModernTreasury::Util.enum_lines(fused_1)
    fused_3 = ModernTreasury::Util.parse_sse(fused_2)
...
class ModernTreasury::Test::UtilSseTest < Minitest::Test
  def test_enum_lines
    ...
    cases.each do |enum, expected|
      lines = ModernTreasury::Util.enum_lines(enum)
  ...
  def test_parse_sse
    ...
    cases.each do |name, test_cases|
      test_cases.each do |input, expected|
        actual = ModernTreasury::Util.parse_sse(input).map(&:compact)
